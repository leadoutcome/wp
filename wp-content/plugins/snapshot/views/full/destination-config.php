<div class="snapshot-config">
	...
	<div class="configure">
		<img src="<?php echo esc_url(WPMUDEVSnapshot::instance()->get_setting( 'SNAPSHOT_PLUGIN_URL' )); ?>/images/destinations-config.png" />
		<p><a href="<?php echo esc_url(WPMUDEVSnapshot::instance()->get_setting( 'SNAPSHOT_MENU_URL' )); ?>snapshots_full_backup_panel" class="button button-primary"><?php esc_html_e('Configure Full Backups', SNAPSHOT_I18N_DOMAIN); ?></a></p>
	</div>

...
Tooltipy (Bluet keywords tooltip generator) allows you to highlight the keywords in your content in order to show a description tooltip
...
= 4.3.11 =
 * Add the 'Prevent other plugins filters' option in the Advanced tab
 
= 4.3.10 =
 * Cover HTML Tags settings
 * Get keywords only for certain HTML Tags
 * Similar to cover class
 * Suggested by @Danielchan - link : https://wordpress.org/support/topic/get-keywords-only-for-h2-titles/
...
= 4.3.8.4 =
* Transient used to cache SQL Query object

= 4.3.8.2 =
* adapted for the new icon extention img URL support
...
= 4.3.8 =
* now you can change the post type name from my_keywords to another one from wp-admin/options.php "tooltipy_post_type_name", be careful the new name shouldn't contain spaces, use underscores instead '_'

= 4.3.7.3 =
* now can work with icon addon

= 4.3.6 =
* advanced custom events added to fetch on a given event
* max height 95% for mobiles

= 4.3.5.1 =
* no space after suffix fixed

= 4.3.5 =
* New animations: flash, fade, tada ...
* Spaces problem fixed

= 4.3.4 =
* Edit pages issue fixed and glossary ling page setting added
* classes in widget fixed

= 4.3.3 =
* multi CSS classes added to keywords and popups so you can easily style you keywords

= 4.2 =
* loading img while loading keywords

= 4.1 =
* fetching keywords and loading synchronized

= 4.0 =
* Now you can choose from which post type you want to get the tooltips content (settings>options>Get tooltips from)
* I jumped directly to v4 thanks to Edgar Mahn and his site www.imperiogames.cl because he needed this feature :)

= 3.0.5 =
* avoid averlapped keywords
= 3.0.4 =
* now works with Japanese and Chinese
= 3.0.2 =
* Overlapping fixed
= 3.0.1 =
* first pro version
= 3.0.0.9 =
* ergonomic class selector
= 3.0.0.8 =
* Responsive
* animation customizable
= 2.6.2.1.0.0.2 =
* une version spéciale de test
= 2.6.2 =

...
<?php if ( $options['social_attention_grabber'] == "count" ): ?>
	<script type="text/javascript">
		...
		<?php if ($options['enable_facebook_button'] == 1): ?>_thrive_share_no_params.facebook = true;
		<?php endif; ?>
		<?php if ($options['enable_twitter_button'] == 1): ?>_thrive_share_no_params.twitter = true;
		<?php endif; ?>
		<?php if ($options['enable_google_button'] == 1): ?>_thrive_share_no_params.google = true;
		<?php endif; ?>
		<?php if ($options['enable_linkedin_button'] == 1): ?>_thrive_share_no_params.linkedin = true;
		<?php endif; ?>
		<?php if ($options['enable_pinterest_button'] == 1): ?>_thrive_share_no_params.pinterest = true;
		<?php endif; ?>
...
<div class="ssf <?php echo $options['enable_floating_icons'] != 1 ? 'apsf' : ''; ?>">
	...
	<div class="scfm">
		<?php if ( $options['enable_facebook_button'] == 1 ): ?>
			<div class="ss">
				<a class="fb" href="//www.facebook.com/sharer/sharer.php?u=<?php echo $current_url; ?>"
		...
		<?php endif; ?>
		<?php
		if ( $options['enable_twitter_button'] == 1 ):
		...
		if ( $options['enable_pinterest_button'] == 1 ): $media_param = ( has_post_thumbnail() ) ? "&media=" . $featured_image : "";
			?>
			<div class="ss">
				<a class="pt"
				   href="https://pinterest.com/pin/create/button/?url=<?php echo $current_url . $media_param; ?>"
				   onclick="return ThriveApp.open_share_popup(this.href, 545, 433);">
		...
		<?php endif; ?>
		<?php
		if ( $options['enable_stumbleupon_button'] == 1 ) {
			?>
			<div class="ss">
				<a class="supon" href="http://www.stumbleupon.com/submit?url=<?php echo $current_url; ?>"
				   onclick="return ThriveApp.open_share_popup(this.href, 545, 433);">
					<span></span>
				</a>
			</div>

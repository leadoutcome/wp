...
$image_type       = $options['featured_image_style'];
if ( $options['featured_image_style'] == "wide" ) {
	$image_type = "tt_featured_wide_narrow";
}
$featured_image_data  = thrive_get_post_featured_image( get_the_ID(), $image_type );
...
<article>
	...
	<?php if ( $options['featured_image_style'] == "wide" && $featured_image ): ?>
		<a class="psb"> <img src="<?php echo $featured_image; ?>" alt="<?php echo $featured_image_alt; ?>"
	...
	<div class="awr">
		<div class="lnd bpd">
			...
			<?php if ( $options['featured_image_style'] == "thumbnail" && $featured_image ): ?>
				<img class="afim pst right" src="<?php echo $featured_image; ?>"
	...
	<?php if ( isset( $options['bottom_previous_next'] ) && $options['bottom_previous_next'] == 1 && get_permalink( get_adjacent_post( false, '', false ) ) != "" && get_permalink( get_adjacent_post( false, '', true ) ) != "" && ! is_page() ): ?>
		<div class="spr"></div>

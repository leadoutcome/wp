	...
	<tr class="thrive_shortcode_price_options" id="thrive_shortcode_price_options1">
		<th scope="row" class="thrive_shortcode_price_options_label_col">
			...
			<div class="thrive_shortcode_price_remove_table" style="display: none;">
				<a class="pure-button remove thrive_shortcode_price_remove_table_btn"
				   href=""><?php _e( "Remove", 'thrive' ); ?></a>
			</div>
		</th>
		<td>
...
<table class="form-table postEdit">
	<tr>
		<td colspan="2" class="thrive_shortcode_submit_container"><input class="pure-button upload" type="button"
		                                                                 id="thrive_shortcode_price_add_table"
		                                                                 value="<?php _e( "Add new table", 'thrive' ); ?>"/>
		</td>
	</tr>
...
<script type="text/javascript">
	...
	jQuery( document ).ready( function () {
		...
		jQuery( "#thrive_shortcode_price_add_table" ).click( function () {
			...
			_new_table_row.find( ".thrive_shortcode_price_options_label" ).html( "Table " + (
			                                                                     jQuery( ".thrive_shortcode_price_options" ).length + 1
				) + " options" );
			...
			_new_table_row.find( ".thrive_shortcode_price_remove_table_btn" ).click( function ( event ) {
				...
				jQuery( ".thrive_shortcode_price_options" ).each( function ( index ) {
					jQuery( this ).find( ".thrive_shortcode_price_options_label" ).html( "Table " + (
					                                                                     index + 1
						) + " options" );
				} );
				return false;

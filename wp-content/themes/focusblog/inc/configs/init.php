...
function thrive_enqueue_scripts() {
	...
	wp_enqueue_style( 'focusblog-style', get_stylesheet_uri() );
...
function thrive_init_widgets() {
	...
	register_sidebar( array(
		...
		'id'            => 'footer-1',
		'before_widget' => '<section id="%1$s" class="col">',
...
function thrive_template_include_to_be_reviewed( $template ) {
	if ( ! is_singular() ) {
		return $template;
	}
...
function thrive_admin_notice() {
	...
	<div class="update-nag">
		<p>
			<?php _e( 'Your theme has successfully been activated! Next step: please validate your license by entering your email and license key here: ', 'thrive' ); ?>

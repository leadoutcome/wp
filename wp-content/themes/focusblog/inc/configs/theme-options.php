...
function thrive_get_default_customizer_options( $color_scheme = null ) {
	...
	switch ( $color_scheme ) {
		case 'green':
			$default_values = array(
				'thrivetheme_link_color'                       => '#7BC143',
				'thrivetheme_highlight_color'                  => '#7BC143',
				'thrivetheme_menu_highlight_color'             => '#7BC143',
				'thrivetheme_headline_color'                   => '#424242',
				'thrivetheme_bodytext_color'                   => '#424242',
				'thrivetheme_header_font'                      => '//fonts.googleapis.com/css?family=Lato&subset=latin-ext,latin',
				'thrivetheme_body_font'                        => '//fonts.googleapis.com/css?family=Open+Sans&subset=latin-ext,latin',
				'thrivetheme_header_fontsize'                  => '38',
				'thrivetheme_body_fontsize'                    => '16',
				'thrivetheme_body_lineheight'                  => '1.6',
				'thrivetheme_default_highlight'                => '#20a850',
				'thrivetheme_highlight_background_color'       => '#20a850',
				'thrivetheme_highlight_link_color'             => '#FFFFFF',
				'thrivetheme_highlight_hover_background_color' => 'transparent',
				'thrivetheme_highlight_hover_link_color'       => '#20a850'

			);
			break;
		case 'red':
			$default_values = array(
				'thrivetheme_link_color'                       => '#f2393f',
				'thrivetheme_highlight_color'                  => '#f2393f',
				'thrivetheme_menu_highlight_color'             => '#f2393f',
				'thrivetheme_headline_color'                   => '#424242',
				'thrivetheme_bodytext_color'                   => '#424242',
				'thrivetheme_header_font'                      => '//fonts.googleapis.com/css?family=Lato&subset=latin-ext,latin',
				'thrivetheme_body_font'                        => '//fonts.googleapis.com/css?family=Open+Sans&subset=latin-ext,latin',
				...
				'thrivetheme_body_fontsize'                    => '16',
				'thrivetheme_body_lineheight'                  => '1.6',
				'thrivetheme_default_highlight'                => '#c0392b',
				'thrivetheme_highlight_background_color'       => '#c0392b',
				'thrivetheme_highlight_link_color'             => '#FFFFFF',
				'thrivetheme_highlight_hover_background_color' => 'transparent',
				'thrivetheme_highlight_hover_link_color'       => '#c0392b'
			);
			break;
		case 'blue':
			$default_values = array(
				'thrivetheme_link_color'                       => '#4174dc',
				'thrivetheme_highlight_color'                  => '#4174dc',
				'thrivetheme_menu_highlight_color'             => '#4174dc',
				'thrivetheme_headline_color'                   => '#424242',
				'thrivetheme_bodytext_color'                   => '#424242',
				'thrivetheme_header_font'                      => '//fonts.googleapis.com/css?family=Lato&subset=latin-ext,latin',
				'thrivetheme_body_font'                        => '//fonts.googleapis.com/css?family=Open+Sans&subset=latin-ext,latin',
				...
				'thrivetheme_body_fontsize'                    => '16',
				'thrivetheme_body_lineheight'                  => '1.6',
				'thrivetheme_default_highlight'                => '#4d7fe3',
				'thrivetheme_highlight_background_color'       => '#4d7fe3',
				'thrivetheme_highlight_link_color'             => '#FFFFFF',
				'thrivetheme_highlight_hover_background_color' => 'transparent',
				'thrivetheme_highlight_hover_link_color'       => '#4d7fe3'
			);
			break;
		case 'orange':
			$default_values = array(
				'thrivetheme_link_color'                       => '#f1913c',
				'thrivetheme_highlight_color'                  => '#f1913c',
				'thrivetheme_menu_highlight_color'             => '#f1913c',
				'thrivetheme_headline_color'                   => '#424242',
				'thrivetheme_bodytext_color'                   => '#424242',
				'thrivetheme_header_font'                      => '//fonts.googleapis.com/css?family=Lato&subset=latin-ext,latin',
				'thrivetheme_body_font'                        => '//fonts.googleapis.com/css?family=Open+Sans&subset=latin-ext,latin',
				...
				'thrivetheme_body_fontsize'                    => '16',
				'thrivetheme_body_lineheight'                  => '1.6',
				'thrivetheme_default_highlight'                => '#e67e22',
				'thrivetheme_highlight_background_color'       => '#e67e22',
				'thrivetheme_highlight_link_color'             => '#FFFFFF',
				'thrivetheme_highlight_hover_background_color' => 'transparent',
				'thrivetheme_highlight_hover_link_color'       => '#e67e22'
			);
			break;
		case 'purple':
			$default_values = array(
				'thrivetheme_link_color'                       => '#9371bd',
				'thrivetheme_highlight_color'                  => '#9371bd',
				'thrivetheme_menu_highlight_color'             => '#9371bd',
				'thrivetheme_headline_color'                   => '#424242',
				'thrivetheme_bodytext_color'                   => '#424242',
				'thrivetheme_header_font'                      => '//fonts.googleapis.com/css?family=Lato&subset=latin-ext,latin',
				'thrivetheme_body_font'                        => '//fonts.googleapis.com/css?family=Open+Sans&subset=latin-ext,latin',
				...
				'thrivetheme_body_fontsize'                    => '16',
				'thrivetheme_body_lineheight'                  => '1.6',
				'thrivetheme_default_highlight'                => '#8e44ad',
				'thrivetheme_highlight_background_color'       => '#8e44ad',
				'thrivetheme_highlight_link_color'             => '#FFFFFF',
				'thrivetheme_highlight_hover_background_color' => 'transparent',
				'thrivetheme_highlight_hover_link_color'       => '#8e44ad'
			);
			break;
		default:
			$default_values = array(
	...
	$default_values['thrivetheme_menu_link_color']  = "#424242";
...
function thrive_get_default_theme_options() {
	...
	$default_theme_options = array(
		...
		'appr_completed_text'          => __('I have completed this lesson', 'thrive'),
		'appr_download_heading'        => __('Resources for this lesson', 'thrive'),
		'appr_replace_lesson'          => __('Lesson', 'thrive'),
		'appr_url_pages'               => __('members', 'thrive'),
		'appr_url_lessons'             => __('lessons', 'thrive'),
		'appr_url_categories'          => __('apprentice', 'thrive'),
...
function thrive_set_default_customizer_options( $color_scheme = null, $resetOnlyColors = false ) {
	...
	if ( ! $resetOnlyColors ) {
		...
		set_theme_mod( "thrivetheme_headline_case", "Uppercase" );

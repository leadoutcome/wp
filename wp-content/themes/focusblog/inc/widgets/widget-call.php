...
class Thrive_Call_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		?>
		<section class="widget cta_widget  <?php echo $widget_container_class; ?>"
			...
			<div class="oab">
				...
				<?php endif; ?>
				<p class="cta_title"><?php echo $instance['headline_text'] ?></p>

				<p class="cta_content"><?php echo $instance['body_text'] ?></p>
				<a href="<?php echo $instance['button_link'] ?>" target="<?php echo $action_link_target; ?>"
				   class="cta_bnt"><?php echo $instance['button_text'] ?></a>
			</div>
		</section>

...
function thrive_meta_focusarea_options( $page ) {
	...
	$value_focus_new_tab         = (int) get_post_meta( $page->ID, '_thrive_meta_focus_new_tab', true );
	...
	$value_focus_image_alt       = get_post_meta( $page->ID, '_thrive_meta_focus_image_alt', true );
...
function _thrive_save_post_options( $post_data ) {
	...
	$thrive_meta_social_data_overwrite   = isset( $post_data['thrive_meta_social_data_overwrite'] ) ? $post_data['thrive_meta_social_data_overwrite'] : 0;
	...
	add_post_meta( $post_ID, '_thrive_meta_social_data_overwrite', $thrive_meta_social_data_overwrite, true ) or
	update_post_meta( $post_ID, '_thrive_meta_social_data_overwrite', $thrive_meta_social_data_overwrite );
...
function _thrive_save_page_options( $post_data ) {
	...
	add_post_meta( $page_ID, '_thrive_meta_social_data_overwrite', $thrive_meta_social_data_overwrite, true ) or
	update_post_meta( $page_ID, '_thrive_meta_social_data_overwrite', $thrive_meta_social_data_overwrite );
...
function _thrive_save_focus_options( $post_data ) {
	...
	$thrive_meta_focus_image_alt       = sanitize_text_field( $post_data['thrive_meta_focus_image_alt'] );
	...
	add_post_meta( $page_ID, '_thrive_meta_focus_image_alt', $thrive_meta_focus_image_alt, true ) or
	update_post_meta( $page_ID, '_thrive_meta_focus_image_alt', $thrive_meta_focus_image_alt );
...
function thrive_focus_render_preview() {
	...
	$current_attrs['_thrive_meta_focus_image_alt'][0]       = $_POST['thrive_meta_focus_image_alt'];

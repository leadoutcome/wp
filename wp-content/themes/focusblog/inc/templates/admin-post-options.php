				...
				<table class="form-table">
					<tr>
						<th scope="row">
							...
							<span class="tooltips"
							      title="<?php echo __( 'Thrive Themes comes with a number of templates that you can use for your content.  Use this option to choose the best template to use on this post/page.', 'thrive' ); ?>"></span>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							...
							<span class="tooltips"
							      title="<?php echo __( 'If set to off, this will remove the author, publication date, tags and category from the post / page.  <br><br>To clarify: This does not change any <meta> tags that are used by the search engines when crawling a web site.', 'thrive' ); ?>"></span>
						</th>
						<td>
							<input type="radio" value="on"
							       name="thrive_meta_post_meta_info"
							       <?php if ( $value_post_meta_info == "on" ): ?>checked<?php endif ?> /> On
							<input type="radio" value="default"
							       name="thrive_meta_post_meta_info"
							       <?php if ( $value_post_meta_info == "default" ): ?>checked<?php endif ?> /> Default
							<input type="radio" value="off"
							       name="thrive_meta_post_meta_info"
							       <?php if ( $value_post_meta_info == "off" ): ?>checked<?php endif ?> /> Off
						</td>
					</tr>
					<tr>
						<th scope="row">
							...
							<span class="tooltips"
							      title="<?php echo __( 'Display or hide the breadcrumb navigation on this post/page.  <a href=\'http://thrivethemes.com/tkb_item/turn-onoff-breadcrumbs-individual-posts-pages-thrive-themes/\'>Read more about breadcrumbs</a>.' ); ?>"></span>
						</th>
						<td>
							<input type="radio" value="on"
					...
					<?php if ( thrive_get_theme_options( "related_posts_box" ) == 1 ): ?>
						<tr>
							...
							<td>
								<input type="radio" value="on"
								       name="thrive_meta_post_related_box"
								       <?php if ( $value_post_related_box != "of" ): ?>checked<?php endif ?> /> On
								<input type="radio" value="off"
								       name="thrive_meta_post_related_box"
								       <?php if ( $value_post_related_box == "off" ): ?>checked<?php endif ?> /> Off
							</td>
						</tr>
					<?php endif; ?>
				</table>
				...
				<table class="form-table">
					...
					<tr>
						<th scope="row">
							...
							<span class="tooltips"
							      title="<?php _e( 'Add any custom CSS that you want to be applied to this post / page.  You should add your CSS code directly into the textarea.<br/><br/>Example:- <br/>h1 {<br/> color:#ff0000<br/>}<br/><br/><a href=\'http://thrivethemes.com/tkb_item/load-scriptscustom-css-individual-postspages-thrive-themes/\'>Read more about custom scripts here</a>.', 'thrive' ); ?>"></span>
						</th>
						<td>
							<textarea

				...
				<select name='thrive_meta_focus_optin' id="thrive_meta_focus_optin">
					...
					<?php foreach ( $queryOptins->get_posts() as $p ): ?>
						<option value='<?php echo $p->ID ?>'
						        <?php if ( $value_focus_optin == $p->ID ): ?>selected<?php endif; ?>><?php echo get_the_title( $p->ID ); ?></option>
					<?php endforeach; ?>
				</select>
			</td>
			<td>
	...
	<div id='container-focus-image' class="thrive_option_container">
		<table class="form-table focusEdit">
			...
			<td>
				...
				<input type="hidden" name="thrive_meta_focus_image_alt" id="thrive_meta_focus_image_alt_hidden"
				       value="<?php echo $value_focus_image_alt; ?>"/>
				<p class="imgButtons">
			...
			<td>
				<div>
					<input class='toggle toggle-left' type='radio' id='thrive_meta_focus_new_tab_true'
					       ...
					       <?php if ( $value_focus_new_tab == 1 ): ?>checked<?php endif ?> />
					...
					<input class='toggle toggle-right' type='radio' id='thrive_meta_focus_new_tab_false'
					       ...
					       <?php if ( $value_focus_new_tab == 0 ): ?>checked<?php endif ?> />

...
function thrive_theme_options_init() {
	...
	add_settings_field( 'meta_post_date_type', $options_titles['meta_post_date_type'], 'thrive_settings_field_meta_post_date_type', 'theme_meta_info_options', 'meta_info_settings', $options );
	...
	add_settings_field( 'enable_stumbleupon_button', $options_titles['enable_stumbleupon_button'], 'thrive_settings_field_enable_stumbleupon_button', 'theme_social_button_options', 'social_buttons_settings', $options );
...
function thrive_theme_options_validate( $input ) {
	...
	if ( isset( $input['blog_layout'] ) ) {
		$output['blog_layout'] = $input['blog_layout'];
	}
	...
	if ( isset( $input['meta_post_date_type'] ) ) {
		$output['meta_post_date_type'] = $input['meta_post_date_type'];
	}
	...
	if ( isset( $input['enable_stumbleupon_button'] ) ) {
		$output['enable_stumbleupon_button'] = $input['enable_stumbleupon_button'];
	}
...
function thrive_settings_field_meta_post_date_type( $options ) {

	$checked_publish  = ( $options['meta_post_date_type'] == 'publish' ) ? "checked" : "";
	$checked_modified = ( $options['meta_post_date_type'] == 'modified' ) ? "checked" : "";
	echo "<input type='radio' name='thrive_theme_options[meta_post_date_type]' value='publish' $checked_publish /> " . __( 'Publish Date', 'thrive' ) . "";
	echo "<input type='radio' name='thrive_theme_options[meta_post_date_type]' value='modified' $checked_modified /> " . __( 'Last Modified Date', 'thrive' ) . "";
}
...
function thrive_settings_field_enable_stumbleupon_button( $options ) {
	if ( ! isset( $options['enable_stumbleupon_button'] ) ) {
		$options['enable_stumbleupon_button'] = 0;
	}
	$checked_enabled  = ( $options['enable_stumbleupon_button'] == 1 ) ? "checked" : "";
	$checked_disabled = ( $options['enable_stumbleupon_button'] != 1 ) ? "checked" : "";

	echo "<input class='toggle toggle-left' id='enable_stumbleupon_button_on' type='radio' name='thrive_theme_options[enable_stumbleupon_button]' value='1' $checked_enabled />
    <label for='enable_stumbleupon_button_on' class='btn'>" . __( 'On', 'thrive' ) . "</label>";
	echo "<input class='toggle toggle-right' id='enable_stumbleupon_button_off' type='radio' name='thrive_theme_options[enable_stumbleupon_button]' value='0' $checked_disabled />
    <label for='enable_stumbleupon_button_off' class='btn'>" . __( 'Off', 'thrive' ) . "</label>";
}

...
class MyTheme_Customize {
	...
	public static function header_output() {
		...
		<style type="text/css">.wp-video-shortcode {
			...
			self::generate_css( '.cnt p', 'color', 'thrivetheme_bodytext_color' );
			...
			self::generate_css( '.bSe h2', 'text-transform', 'thrivetheme_headline_case', '' );
			...
			// self::generate_css('.arl', 'background-color', 'thrivetheme_highlight_color');
			...
			self::generate_css( 'header ul.menu > li.h-cta:hover > a', 'color', 'thrivetheme_highlight_hover_link_color', '', '!important' );
	...
	public static function generate_css( $selector, $style, $mod_name, $prefix = '', $postfix = '', $echo = true ) {
		...
		if ( $mod_name == "thrivetheme_headline_case" ) {
			$mod = strtolower( get_theme_mod( "thrivetheme_headline_case" ) ) == "uppercase" ? "uppercase" : "none";
		}

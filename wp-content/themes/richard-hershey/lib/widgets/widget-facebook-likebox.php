<?php
/**
 * Facebook like box widget for childgenesis
 * 
...
class GA_Facebook_Likebox_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'ga-facebook-likebox', 'description' => __( 'Displays Facebook Page Likebox', 'childgenesis' ) );
		$this->WP_Widget( 'ga-facebook-likebox', __( 'ChildGenesis : Facebook Likebox', 'childgenesis' ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title'       => __( 'Like us on Facebook', 'childgenesis' ),
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'pageurl' ) ?>"><?php esc_html_e( 'Facebook Page URL', 'childgenesis' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'width' ) ?>"><?php esc_html_e( 'Width', 'childgenesis' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'height' ) ?>"><?php esc_html_e( 'Height', 'childgenesis' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'colorscheme' ) ?>"><?php esc_html_e( 'Color Scheme', 'childgenesis' ); ?></label>
			<select class="widefat" name="<?php echo $this->get_field_name( 'colorscheme' ) ?>" id="<?php echo $this->get_field_id( 'colorscheme' ) ?>">
				<option value="light"<?php selected( 'light', $colorscheme ); ?>><?php esc_html_e( 'Light', 'childgenesis' ) ?></option>
				<option value="dark"<?php selected( 'dark', $colorscheme ); ?>><?php esc_html_e( 'Dark', 'childgenesis' ) ?></option>
			</select>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'bordercolor' ) ?>"><?php esc_html_e( 'Border Color', 'childgenesis' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'showfaces' ) ?>"><?php esc_html_e( 'Show Faces', 'childgenesis' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'showstream' ) ?>"><?php esc_html_e( 'Show Stream', 'childgenesis' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'showheader' ) ?>"><?php esc_html_e( 'Show Header', 'childgenesis' ); ?></label>
		</p>

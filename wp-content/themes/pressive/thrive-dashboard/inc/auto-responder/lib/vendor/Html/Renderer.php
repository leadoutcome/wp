...
class Thrive_Dash_Api_Html_Renderer {
	...
	public function getApiFields() {
		...
		//TODO: remove this feature until is fully tested.
		$account = false;
	...
	protected function _validationOptions( $field, $element ) {
		...
		<?php if ( $account ) : ?>
			<option value="password"<?php echo $selected == 'password' ? ' selected="selected"' : '' ?>><?php echo __( 'Password', TVE_DASH_TRANSLATE_DOMAIN ) ?></option>
		<?php endif; ?>
		</select><?php
	}

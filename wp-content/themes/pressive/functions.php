	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<input id="show_facebook" value="sh" type="checkbox"
				       name="show_social_profiles[]" <?php echo ( in_array( 'sh', $show_social_profiles ) ) ? "checked" : ""; ?> />
				<label for="show_facebook"><?php _e( "Facebook", 'thrive' ); ?></label>
				<input id="show_twitter" value="fbi" type="checkbox"
				       name="show_social_profiles[]" <?php echo ( in_array( 'fbi', $show_social_profiles ) ) ? "checked" : ""; ?> />
				<label for="show_twitter"><?php _e( "Twitter", 'thrive' ); ?></label>
				<input id="show_linkedin" value="ini" type="checkbox"
				       name="show_social_profiles[]" <?php echo ( in_array( 'ini', $show_social_profiles ) ) ? "checked" : ""; ?> />
				...
				<input id="show_googleplus" value="gi" type="checkbox"
				       name="show_social_profiles[]" <?php echo ( in_array( 'gi', $show_social_profiles ) ) ? "checked" : ""; ?> />
			...
			default :
				...
				<div class="cmb" id="comment-<?php echo get_comment_ID(); ?>">
					<div class="<?php echo $comment_container_class; ?>">
						<div class="left">
							<?php echo get_avatar( get_comment_author_email(), 94 ); ?>
						</div>
					...
					<div class="lrp" id="respond-container-<?php echo get_comment_ID(); ?>" style="display: none;">
						...
						<form action="<?php echo site_url( '/wp-comments-post.php' ) ?>" method="post">
							<?php if ( ! is_user_logged_in() ): ?>
								...
								<label class=" l-lst" for="website"><?php _e( "Website", 'thrive' ); ?></label>
								<div class="clear"></div>
								...
								<input type="text" author="website" id="website"
								       placeholder="" name="website" class="l-lst">
								<div class="clear"></div>
...
/**
 * Add filter for graphic lib when uploading images
 */
add_filter( 'wp_image_editors', 'change_graphic_lib' );
function change_graphic_lib( $array ) {
	return array_merge( array( 'WP_Image_Editor_GD', 'WP_Image_Editor_Imagick' ), $array );
}

	...
	<?php if ( $post_format == "quote" ): ?>
		<a href="<?php echo the_permalink(); ?>" class="q-lk">
			<div class="ind-q <?php if ( has_post_thumbnail() ): ?>ind-qi<?php endif; ?>"
			     <?php if ( has_post_thumbnail() ): ?>style="background-image: url('<?php echo thrive_get_post_featured_image_src( get_the_ID(), "tt_grid_layout" ); ?>')"<?php endif; ?>>
				<div class="quo">
			...
			<div
				...
				<div class="awr-i">
					...
					<h2 class="entry-title"><a
							href="<?php the_permalink(); ?>"><?php echo thrive_trim_title_words( get_the_title() ); ?></a>
					</h2>
		...
		<?php if ( $post_format == "video" ): ?>
			...
			<?php if ( has_post_thumbnail() ): ?>
				<div class="scvps<?php echo $wistiaVideoCode; ?>"
				     style="background-image: url('<?php echo thrive_get_post_featured_image_src( get_the_ID(), "tt_grid_layout" ); ?>')">
					<div class="vdc lv">
						<div class="ltx">
							<div class="pvb">
								<a href=""></a>
			...
			<?php endif; ?>
		<?php endif; ?>
		<?php if ( has_post_thumbnail() && $post_format != "video" && $post_format != "audio" ): ?>

		...
		foreach ( $post_data as $key => $val ) {
			if ( in_array( $key, $page_templates ) ) {
				...
				if ( isset( $_POST['editable_with_tcb'] ) && $_POST['editable_with_tcb'] == 1 && defined( "TVE_VERSION" ) ) {
					...
					update_post_meta( $post_id, 'tve_style_family', "Minimal" );
				...
				switch ( $key ) {
					...
					case 'page_tpl_homepage1':
						...
						add_post_meta( $post_id, '_thrive_meta_post_breadcrumbs', "off", true ) or
						update_post_meta( $post_id, '_thrive_meta_post_breadcrumbs', "off" );
						add_post_meta( $post_id, '_thrive_meta_post_featured_image', "top", true ) or
						update_post_meta( $post_id, '_thrive_meta_post_featured_image', "top" );
						add_post_meta( $post_id, '_thrive_meta_show_content_title', 1, true ) or
						update_post_meta( $post_id, '_thrive_meta_show_content_title', 1 );
						add_post_meta( $post_id, '_thrive_meta_post_title_bg_type', "image", true ) or
						update_post_meta( $post_id, '_thrive_meta_post_title_bg_type', "image" );
						add_post_meta( $post_id, '_thrive_meta_post_title_bg_overlay_type', "none", true ) or
						update_post_meta( $post_id, '_thrive_meta_post_title_bg_overlay_type', "none" );

						add_post_meta( $post_id, '_thrive_meta_content_title', _thrive_generate_page_template_content( $key, $optin_id, true ), true ) or
						update_post_meta( $post_id, '_thrive_meta_content_title', _thrive_generate_page_template_content( $key, $optin_id, true ) );
						$featured_img_url = "http://pressive.thrivethemes.com/wp-content/uploads/2014/11/night-track.jpg";
						_thrive_insert_post_featured_img( $featured_img_url, $post_id );
						break;
					case 'page_tpl_homepage2':
						...
						add_post_meta( $post_id, '_thrive_meta_post_title_bg_type', "image", true ) or
						update_post_meta( $post_id, '_thrive_meta_post_title_bg_type', "image" );
						add_post_meta( $post_id, '_thrive_meta_post_title_bg_overlay_type', "dots", true ) or
						update_post_meta( $post_id, '_thrive_meta_post_title_bg_overlay_type', "dots" );
						$featured_img_url = "http://pressive.thrivethemes.com/wp-content/uploads/2014/11/urban_skyline_manhattan_bw.jpg";
						_thrive_insert_post_featured_img( $featured_img_url, $post_id );
						break;
					case 'page_tpl_homepage3':
						...
						add_post_meta( $post_id, '_thrive_meta_post_title_bg_overlay_type', "dots", true ) or
						update_post_meta( $post_id, '_thrive_meta_post_title_bg_overlay_type', "dots" );
						$featured_img_url = "http://pressive.thrivethemes.com/wp-content/uploads/2014/11/background-2.jpg";
						_thrive_insert_post_featured_img( $featured_img_url, $post_id );
						break;
					...
					case 'page_tpl_thank_you':
						...
						$featured_img_url = "http://pressive.thrivethemes.com/wp-content/uploads/2014/11/background-3.jpg";
						_thrive_insert_post_featured_img( $featured_img_url, $post_id );
						break;
					case 'page_tpl_sales_1':
						...
						$featured_img_url = "http://pressive.thrivethemes.com/wp-content/uploads/2014/11/bridge.jpg";
						_thrive_insert_post_featured_img( $featured_img_url, $post_id );
						break;
				}
			}
...
function _thrive_generate_page_template_content( $template, $optin_id = 0, $top_section = false ) {
	...
	switch ( $template ) {
		...
		case 'page_tpl_disclaimer':
			...
			break;
		case 'page_tpl_lead_generation':
			return _thrive_get_page_template_lead_gen( $optin_id, $top_section );
			break;
		case 'page_tpl_email_confirmation':
			return _thrive_get_page_template_email_confirmation( $top_section );
			break;
		case 'page_tpl_thank_you':
			return _thrive_get_page_template_thank_you_dld( $top_section );
			break;
		case 'page_tpl_sales_1':
			return _thrive_get_page_template_sales( $top_section );
			break;
		case 'page_tpl_video_lead_generation':
			return _thrive_get_page_template_video_lead_gen( $optin_id, $top_section );
			break;
		case 'page_tpl_homepage1':
			return _thrive_get_page_template_homepage1( $optin_id, $top_section );
			break;
		case 'page_tpl_homepage2':
			return _thrive_get_page_template_homepage2( $optin_id, $top_section );
			break;
		case 'page_tpl_homepage3':
			return _thrive_get_page_template_homepage3( $optin_id, $top_section );
			break;
		default:
			return "";
	}

...
function _thrive_get_page_template_lead_gen( $optin_id = 0, $top_section = false ) {
...
function _thrive_get_page_template_email_confirmation( $top_section = false ) {
	$images_dir = get_template_directory_uri() . "/images/templates/";
...
function _thrive_get_page_template_video_lead_gen( $optin_id = 0, $top_section = false ) {
	$images_dir = get_template_directory_uri() . "/images/templates/";
...
function _thrive_get_page_template_homepage1( $optin_id = 0, $top_section = false ) {
	$images_dir = get_template_directory_uri() . "/images/templates/";
...
function _thrive_get_page_template_homepage2( $optin_id = 0, $top_section = false ) {
	$images_dir = get_template_directory_uri() . "/images/templates/";
...
function _thrive_get_page_template_homepage3( $optin_id = 0, $top_section = false ) {
	$images_dir = get_template_directory_uri() . "/images/templates/";
...
function _thrive_get_page_template_sales( $top_section = false ) {
	$images_dir = get_template_directory_uri() . "/images/templates/";
...
function _thrive_get_page_template_thank_you_dld( $top_section = false ) {
	$options    = array(
		'website' => thrive_get_theme_options( 'privacy_tpl_website' ),
		'company' => thrive_get_theme_options( 'privacy_tpl_company' ),
		'contact' => thrive_get_theme_options( 'privacy_tpl_contact' ),

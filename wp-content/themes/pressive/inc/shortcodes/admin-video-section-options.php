...
<table class="form-table postEdit">
			...
			<table class="form-table postEdit">
				<tr>
					<td scope="row" colspan="2">
						<input type="radio" name="thrive_shortcode_borderless_video_type"
						       class="thrive_shortcode_borderless_video_type"
				...
				<tr class="thrive_shortcode_container_video_youtube noBorder">
					...
					<td>
						...
						<input type="checkbox" name="thrive_shortcode_borderless_youtube_hide_controls"
						       id="thrive_shortcode_borderless_youtube_hide_controls"
						...
						<input type="checkbox" name="thrive_shortcode_borderless_youtube_hide_title"
						       id="thrive_shortcode_borderless_youtube_hide_title"
						...
						<input type="checkbox" name="thrive_shortcode_borderless_youtube_hide_fullscreen"
						       id="thrive_shortcode_borderless_youtube_hide_fullscreen"
	...
	<tr>
		...
		<td>
			<input type="radio" name="thrive_shortcode_bg_type" class="thrive_shortcode_bg_type" value="image"
			       checked/> <?php _e( "Image", 'thrive' ); ?>
			<input type="radio" name="thrive_shortcode_bg_type" class="thrive_shortcode_bg_type"
			       value="pattern"/> <?php _e( "Pattern", 'thrive' ); ?>
			<input type="radio" name="thrive_shortcode_bg_type" class="thrive_shortcode_bg_type"
			       value="solid"/> <?php _e( "Solid", 'thrive' ); ?>
		</td>
	</tr>
...
<script type="text/javascript">
	...
	jQuery( document ).ready( function () {
		...
		jQuery( ".thrive_shortcode_bg_type" ).click( function () {
			var _selected_bg_type = jQuery( this ).val();
			if ( _selected_bg_type == "solid" ) {
				jQuery( this ).parents( ".postEdit" ).find( "#thrive_shortcode_container_bg_solid" ).show();
				jQuery( this ).parents( ".postEdit" ).find( "#thrive_shortcode_container_bg_image" ).hide();
				jQuery( this ).parents( ".postEdit" ).find( "#thrive_shortcode_container_bg_pattern" ).hide();
			} else if ( _selected_bg_type == "image" ) {
				jQuery( this ).parents( ".postEdit" ).find( "#thrive_shortcode_container_bg_image" ).show();
				jQuery( this ).parents( ".postEdit" ).find( "#thrive_shortcode_container_bg_solid" ).hide();
				jQuery( this ).parents( ".postEdit" ).find( "#thrive_shortcode_container_bg_pattern" ).hide();
			} else {
				jQuery( this ).parents( ".postEdit" ).find( "#thrive_shortcode_container_bg_pattern" ).show();
				jQuery( this ).parents( ".postEdit" ).find( "#thrive_shortcode_container_bg_solid" ).hide();
				jQuery( this ).parents( ".postEdit" ).find( "#thrive_shortcode_container_bg_image" ).hide();
			}
		} );

<table class="form-table postEdit">
	...
	<tr>
		...
		<td>
			<label>
				<input checked="" value="dark" type="radio" name="custom_box_text_style"/>
				Dark
			</label>
			<label>
				<input value="light" type="radio" name="custom_box_text_style"/>
				Light
			</label>
		</td>
	</tr>
...
<script type="text/javascript">
	...
	jQuery( document ).ready( function () {
		...
		jQuery( "#thrive_shortcode_btn_insert" ).click( function () {
			...
			var sc_text = '[thrive_testimonial name="' + sc_options.name + '" company="' + sc_options.company + '" image="' + sc_options.image + '" color="' + sc_options.style + '"]' + sc_options.content + '[/thrive_testimonial]';

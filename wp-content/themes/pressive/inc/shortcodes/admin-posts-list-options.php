...
<script type="text/javascript">
	...
	jQuery( document ).ready( function () {
		jQuery( "#thrive_shortcode_btn_insert" ).click( function () {
			...
			var sc_text = '[thrive_posts_list' + _sc_cat_txt + ' title="' + sc_options.title + '" no_posts="' + sc_options.no_posts + '" filter="' + sc_options.filter + '" thumbnails="' + sc_options.thumbnails + '"]';

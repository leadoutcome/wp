<table class="form-table postEdit">
	...
	<tr>
		...
		<td>
			<input type="radio" value="_self" class="thrive_shortcode_option_button_tab"
			       name="thrive_shortcode_option_button_tab" checked/> <?php _e( "Same tab", 'thrive' ); ?>
			<input type="radio" value="_blank" class="thrive_shortcode_option_button_tab"
			       name="thrive_shortcode_option_button_tab"/> <?php _e( "New tab", 'thrive' ); ?>
		</td>
	</tr>
	<tr>
		<th scope="row">
	...
	<tr>
		...
		<td>
			<input type="radio" value="" class="thrive_shortcode_option_button_align"
			       name="thrive_shortcode_option_button_align" checked
			       value="normal"/> <?php _e( "In place", 'thrive' ); ?>
			<input type="radio" value="left" class="thrive_shortcode_option_button_align"
			       name="thrive_shortcode_option_button_align" value="left"/> <?php _e( "Left", 'thrive' ); ?>
			<input type="radio" value="aligncenter" class="thrive_shortcode_option_button_align"
			       name="thrive_shortcode_option_button_align" value="center"/> <?php _e( "Center", 'thrive' ); ?>
			<input type="radio" value="right" class="thrive_shortcode_option_button_align"
			       name="thrive_shortcode_option_button_align" value="right"/> <?php _e( "Right", 'thrive' ); ?>
			<input type="radio" value="full" class="thrive_shortcode_option_button_align"
			       name="thrive_shortcode_option_button_align" value="full"/> <?php _e( "Full width", 'thrive' ); ?>
		</td>
	</tr>
	<tr>
		<td></td>

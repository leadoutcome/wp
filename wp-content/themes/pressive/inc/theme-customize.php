...
class MyTheme_Customize {
	...
	public static function header_output() {
		...
		<style type="text/css">.wp-video-shortcode {
			...
			self::generate_css( '.cnt article h1.entry-title a', 'color', 'thrivetheme_headline_color', '' );
			self::generate_css( '.cnt article h2.entry-title a', 'color', 'thrivetheme_headline_color', '' );
			self::generate_css( '.bSe h1, .b-tt h1', 'color', 'thrivetheme_headline_color', '' );
			self::generate_css( '.bSe h2, .b-tt h2', 'color', 'thrivetheme_headline_color', '' );
			self::generate_css( '.bSe h3, .b-tt h3', 'color', 'thrivetheme_headline_color', '' );
			self::generate_css( '.bSe h4, .b-tt h4', 'color', 'thrivetheme_headline_color', '' );
			self::generate_css( '.bSe h5, .b-tt h5', 'color', 'thrivetheme_headline_color', '' );
			self::generate_css( '.bSe h6, .b-tt h6', 'color', 'thrivetheme_headline_color', '' );
			self::generate_css( '.cnt article p, .b-tt p', 'color', 'thrivetheme_bodytext_color' );
			self::generate_css( '.cnt .bSe article, .cnt .bSe .tve-c p', 'color', 'thrivetheme_bodytext_color' );
			...
			self::generate_css( '.bSe h1, .b-tt h1', 'font-family', 'thrivetheme_header_font', '' );
			self::generate_css( '.bSe h2,.tve-woocommerce .bSe h2, .b-tt h2', 'font-family', 'thrivetheme_header_font', '' );
			self::generate_css( '.bSe h3,.tve-woocommerce .bSe h3, .b-tt h3', 'font-family', 'thrivetheme_header_font', '' );
			self::generate_css( '.bSe h4, .b-tt h4', 'font-family', 'thrivetheme_header_font', '' );
			self::generate_css( '.bSe h5, .b-tt h5', 'font-family', 'thrivetheme_header_font', '' );
			self::generate_css( '.bSe h6, .b-tt h6', 'font-family', 'thrivetheme_header_font', '' );
			self::generate_css( '#text_logo', 'font-family', 'thrivetheme_header_font', '' );
			...
			self::generate_css( '.cnt article h1 a', 'font-weight', 'thrivetheme_headline_weight', '' );
			self::generate_css( '.bSe h1, .b-tt h1', 'font-weight', 'thrivetheme_headline_weight', '' );
			self::generate_css( '.bSe h2, .b-tt h2', 'font-weight', 'thrivetheme_headline_weight', '' );
			self::generate_css( '.bSe h3, .b-tt h3', 'font-weight', 'thrivetheme_headline_weight', '' );
			self::generate_css( '.bSe h4, .b-tt h4', 'font-weight', 'thrivetheme_headline_weight', '' ); // 400
			self::generate_css( '.bSe h5, .b-tt h5', 'font-weight', 'thrivetheme_headline_weight', '' ); // 400
			self::generate_css( '.bSe h6, .b-tt h6', 'font-weight', 'thrivetheme_headline_weight', '' ); // 700
			self::generate_css( '.cnt, .bp-t, .b-tt p, .b-tt, .tve-woocommerce .product p, .tve-woocommerce .products p', 'font-family', 'thrivetheme_body_font' );
			self::generate_css( '.bSe h1, .b-tt .entry-title, .ind .bSe .awr .awr-i .entry-title', 'font-size', 'thrivetheme_header_fontsize', '', 'px' );
			self::generate_css( '.cnt, .b-tt p, .b-tt', 'font-size', 'thrivetheme_body_fontsize', '', 'px' );
			...
			self::generate_css( '.cnt p, .tve-c', 'line-height', 'thrivetheme_body_lineheight', '', 'em' );
			self::generate_css( '.thrivecb', 'line-height', 'thrivetheme_body_lineheight', '', 'em' );
			self::generate_css( '.bSe a, .cnt article a', 'color', 'thrivetheme_link_color', '' );
			self::generate_css( '.bSe h1, .b-tt h1', 'text-transform', 'thrivetheme_headline_case', '' );
			...
			self::generate_css( 'header nav > ul.menu > li > a', 'color', 'thrivetheme_menu_link_color', '' );
			self::generate_css( 'header nav > ul.menu > li >  a:hover', 'color', 'thrivetheme_menu_highlight_color', '' );
			...
			self::generate_css( 'header ul.menu > li.h-cta > a', 'border-color', 'thrivetheme_highlight_link_color', '' );
	...
	public static function generate_fonts_includes() {
		...
		if ( $header_font ) {
			if ( Tve_Dash_Font_Import_Manager::isImportedFont( $header_font ) ) {
				$header_font = Tve_Dash_Font_Import_Manager::getCssFile();
		...
		if ( $body_font ) {
			if ( Tve_Dash_Font_Import_Manager::isImportedFont( $body_font ) ) {
				$body_font = Tve_Dash_Font_Import_Manager::getCssFile();
	...
	public static function live_preview() {
		...
		wp_enqueue_script(
			'mytheme-themecustomizer', get_template_directory_uri() . '/inc/js/theme-customizer.js', array(
			'jquery',
			'customize-preview'
		), '', true
		);
	...
	public static function get_font_params( $font_link ) {
		if ( tve_dash_font_manager_is_safe_font( $font_link ) ) {
			return tve_dash_font_manager_get_safe_font( $font_link );
		}

		if ( Tve_Dash_Font_Import_Manager::isImportedFont( $font_link ) ) {
			return array(
	...
	public static function generate_css( $selector, $style, $mod_name, $prefix = '', $postfix = '', $echo = true ) {
		...
		//fix for the heading bold issue
		if ( ( $selector == ".bSe h4" || $selector == ".bSe h5" ) && $mod == "300" ) {
			$mod = 500;
		}
		if ( $selector == ".bSe h6" && $mod == "300" ) {
			$mod = 700;
		}
		...
		if ( $mod_name == "thrivetheme_headline_weight" && $mod == "Bold" ) {
			$mod = 700;
		}

		if ( $mod_name == "thrivetheme_headline_weight" && $mod != "Bold" && $mod != 700 ) {
			$mod = 500;
		}

		if ( $mod_name == 'thrivetheme_header_font' || $mod_name == 'thrivetheme_body_font' ) {
			if ( ! $mod || ( strpos( $mod, "=" ) === false && ! tve_dash_font_manager_is_safe_font( $mod ) && ! Tve_Dash_Font_Import_Manager::isImportedFont( $mod ) ) ) {
				$default_values = thrive_get_default_customizer_options();
		...
		if ( $mod_name == "thrivetheme_highlight_hover_background_color" ) {
			if ( get_theme_mod( $mod_name ) == "transparent" ) {
				$mod = get_theme_mod( $mod_name );
			}
		}

...
function thrive_appr_theme_options_init() {
	...
	add_settings_field( 'appr_featured_title_bg_color_type', $options_titles['featured_title_bg_color_type'], 'thrive_settings_field_appr_featured_title_bg_color_type', 'theme_appr_layout_options', 'appr_layout_settings', $options['appr_featured_title_bg_color_type'] );
	add_settings_field( 'appr_featured_title_bg_type', $options_titles['featured_title_bg_type'], 'thrive_settings_field_appr_featured_title_bg_type', 'theme_appr_layout_options', 'appr_layout_settings', $options['appr_featured_title_bg_type'] );
	add_settings_field( 'appr_featured_title_bg_solid_color', $options_titles['featured_title_bg_solid_color'], 'thrive_settings_field_appr_featured_title_bg_solid_color', 'theme_appr_layout_options', 'appr_layout_settings', $options['appr_featured_title_bg_solid_color'] );
	add_settings_field( 'appr_featured_title_bg_img_trans', $options_titles['featured_title_bg_img_trans'], 'thrive_settings_field_appr_featured_title_bg_img_trans', 'theme_appr_layout_options', 'appr_layout_settings', $options['appr_featured_title_bg_img_trans'] );
	add_settings_field( 'appr_featured_title_bg_img_default_src', $options_titles['featured_title_bg_img_default_src'], 'thrive_settings_field_appr_featured_title_bg_img_default_src', 'theme_appr_layout_options', 'appr_layout_settings', $options['appr_featured_title_bg_img_default_src'] );
...
function thrive_settings_field_appr_featured_title_bg_type( $value ) {
	$checked_img   = ( $value == "image" ) ? "checked" : "";
	$checked_color = ( $value == "color" ) ? "checked" : "";

	echo "<input class='toggle toggle-left thrive_appr_featured_title_bg_type' type='radio' id='appr_featured_title_bg_type_image' name='thrive_theme_options[appr_featured_title_bg_type]' value='image' $checked_img />
    <label for='appr_featured_title_bg_type_image' class='btn'>" . __( 'Image', 'thrive' ) . "</label>";
	echo "<input class='toggle toggle-right thrive_appr_featured_title_bg_type' type='radio' id='appr_featured_title_bg_type_color' name='thrive_theme_options[appr_featured_title_bg_type]' value='color' $checked_color />
    <label for='appr_featured_title_bg_type_color' class='btn'>" . __( 'Color', 'thrive' ) . "</label>";
}

function thrive_settings_field_appr_featured_title_bg_img_trans( $value ) {
	$scheme_options = thrive_get_default_customizer_options();
	echo "<input type='hidden' name='thrive_theme_options[appr_featured_title_bg_img_trans]' value='" . $value . "' id='thrive_hidden_appr_featured_title_bg_img_trans' />";
	echo "<input type='hidden' id='thrive_hidden_theme_color' value='" . $scheme_options['thrivetheme_link_color'] . "' />";
	echo "<select id='thrive_select_appr_featured_title_bg_img_trans'>";
	...
	echo "<option value='dots'>" . __( "Dots", 'thrive' ) . "</option>";
	echo "<option value='blur'>" . __( "Blur", 'thrive' ) . "</option>";
	echo "</select>";
	echo "<div style='display:none;' id='thrive_custom_appr_featured_title_bg_img_trans_container'><input type='text' id='thrive_custom_appr_featured_title_bg_img_trans' value='" . esc_attr( $value ) . "'/></div>";

}

function thrive_settings_field_appr_featured_title_bg_solid_color( $value ) {
	$scheme_options = thrive_get_default_customizer_options();
	echo "<input type='text' name='thrive_theme_options[appr_featured_title_bg_solid_color]' id='thrive_theme_options_appr_featured_title_bg_solid_color'
        value='" . esc_attr( $value ) . "' data-default-color='" . $scheme_options['thrivetheme_link_color'] . "' />";
	echo "<input class='thrive_options pure-button clear-field remove' type='button' id='thrive_theme_options_appr_featured_title_bg_solid_color_reset' value='" . __( "Clear", 'thrive' ) . "' />";
}

function thrive_settings_field_appr_featured_title_bg_img_default_src( $value ) {
	echo "<input class='thrive_options' type='text' name='thrive_theme_options[appr_featured_title_bg_img_default_src]' id='thrive_theme_options_appr_featured_title_bg_img_default_src' value='" . esc_attr( $value ) . "' /><br/>";
	echo "<input class='thrive_options pure-button upload' type='button' id='thrive_theme_options_appr_featured_title_bg_img_default_src_btn' value=' " . __( "Upload" ) . " ' />";
	echo "<input class='thrive_options pure-button clear-field remove' type='button' id='thrieve_theme_btn_delete_appr_featured_title_bg_img_default_src' value=' " . __( "Remove" ) . " ' />";
}

function thrive_settings_field_appr_featured_title_bg_color_type( $value ) {

	$checked_light = ( $value == "light" ) ? "checked" : "";
	$checked_dark  = ( $value == "dark" ) ? "checked" : "";

	echo "<input class='toggle toggle-left thrive_appr_featured_title_bg_color_type' type='radio' id='appr_featured_title_bg_color_type_light' name='thrive_theme_options[appr_featured_title_bg_color_type]' value='light' $checked_light />
    <label for='appr_featured_title_bg_color_type_light' class='btn'>" . __( 'Light', 'thrive' ) . "</label>";
	echo "<input class='toggle toggle-right appr_featured_title_bg_color_type' type='radio' id='appr_featured_title_bg_color_type_dark' name='thrive_theme_options[appr_featured_title_bg_color_type]' value='dark' $checked_dark />
    <label for='appr_featured_title_bg_color_type_dark' class='btn'>" . __( 'Dark', 'thrive' ) . "</label>";
}

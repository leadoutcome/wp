...
function thrive_save_appr_postdata( $post_id ) {
	...
	if ( TT_APPR_POST_TYPE_LESSON == $_POST['post_type'] ) {
		_thrive_save_page_options( $_POST ); // left this here because I have no idea why it's called here
		if ( ! empty( $_POST['appr_nonce'] ) && wp_verify_nonce( $_POST['appr_nonce'], 'appr_meta_box' ) ) {
...
function _thrive_save_apprentice_lesson_options( $post_data ) {
	...
	$checkList = array(
		'thrive_meta_appr_lesson_type',
		'thrive_meta_appr_download_links',
		'thrive_meta_appr_video_type',
		'thrive_meta_appr_video_youtube_url',
		'thrive_meta_appr_video_vimeo_url',
		'thrive_meta_appr_video_custom_url',
		'thrive_meta_appr_video_custom_embed',
		'thrive_meta_appr_quote_text',
		'thrive_meta_appr_quote_author',
		'thrive_meta_appr_audio_type',
		'thrive_meta_appr_audio_file',
		'thrive_meta_appr_audio_soundcloud_url',
		'thrive_meta_appr_audio_soundcloud_autoplay',
		'thrive_meta_appr_gallery_images'
	);
	...
	$thrive_meta_appr_video_youtube_hide_related    = isset( $post_data['thrive_meta_appr_video_youtube_hide_related'] ) ? $post_data['thrive_meta_appr_video_youtube_hide_related'] : '';
	$thrive_meta_appr_video_youtube_hide_logo       = isset( $post_data['thrive_meta_appr_video_youtube_hide_logo'] ) ? $post_data['thrive_meta_appr_video_youtube_hide_logo'] : '';
	$thrive_meta_appr_video_youtube_hide_controls   = isset( $post_data['thrive_meta_appr_video_youtube_hide_controls'] ) ? $post_data['thrive_meta_appr_video_youtube_hide_controls'] : '';
	$thrive_meta_appr_video_youtube_hide_title      = isset( $post_data['thrive_meta_appr_video_youtube_hide_title'] ) ? $post_data['thrive_meta_appr_video_youtube_hide_title'] : '';
	$thrive_meta_appr_video_youtube_autoplay        = isset( $post_data['thrive_meta_appr_video_youtube_autoplay'] ) ? $post_data['thrive_meta_appr_video_youtube_autoplay'] : '';
	$thrive_meta_appr_video_youtube_hide_fullscreen = isset( $post_data['thrive_meta_appr_video_youtube_hide_fullscreen'] ) ? $post_data['thrive_meta_appr_video_youtube_hide_fullscreen'] : '';
	...
	$thrive_meta_appr_audio_soundcloud_autoplay     = isset( $post_data['thrive_meta_appr_audio_soundcloud_autoplay'] ) ? $post_data['thrive_meta_appr_audio_soundcloud_autoplay'] : '';
	...
	if ( ! empty( $thrive_meta_appr_audio_soundcloud_url ) ) {
		$soundcloudParams = array(
			'url'       => $thrive_meta_appr_audio_soundcloud_url,

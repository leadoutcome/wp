...
class Thrive_Call_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<section class="widget cta_widget" id="<?php echo $args['widget_id']; ?>">
			<div class="opt opt-<?php echo $widget_style ?> <?php echo $widget_container_class; ?>">
				<?php if ( $widget_style == 1 ): ?>
					<h3><?php echo $instance['headline_text'] ?></h3>
				<?php endif; ?>
				<?php if ( $widget_style == 2 ): ?>
					<div class="o-cr"></div>
				<?php endif; ?>
				<?php if ( isset( $instance['custom_image'] ) && $instance['custom_image'] != "" ): ?>
					<div class="o-im" style="background-image: url('<?php echo $instance['custom_image']; ?>')"></div>
				<?php endif; ?>
				<?php if ( $widget_style != 1 ): ?>
					<h3><?php echo $instance['headline_text'] ?></h3>
				<?php endif; ?>
				...
				<a href="<?php echo $instance['button_link'] ?>" target="<?php echo $action_link_target; ?>"
				   class="cta_bnt ctaLink o-bt"><?php echo $instance['button_text'] ?></a>
	...
	function form( $instance ) {
		...
		<p>
			...
			<br/>
			<img src="<?php echo get_template_directory_uri() . '/inc/images/optin1.jpg' ?>" alt=""/>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'widget_style' ) ); ?>" class=""
			       value="1"
			       <?php if ( $widget_style != 2 && $widget_style != 3 ): ?>checked<?php endif ?> />
			<img src="<?php echo get_template_directory_uri() . '/inc/images/optin2.jpg' ?>" alt=""/>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'widget_style' ) ); ?>" class=""
			       value="2"
			       <?php if ( $widget_style == 2 ): ?>checked<?php endif ?> />
			<img src="<?php echo get_template_directory_uri() . '/inc/images/optin3.jpg' ?>" alt=""/>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'widget_style' ) ); ?>" class=""
			       value="3"
			       <?php if ( $widget_style == 3 ): ?>checked<?php endif ?> />
		</p>

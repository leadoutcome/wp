<table class="form-table postEdit">
	...
	<tr class="image-group">
		...
		<td>
			...
			<input type="button" class="pure-button upload" id="custom_box_image_upload_btn"
			       value="<?php _e( "Upload", 'thrive' ); ?>"/>
			<input type="button" class="pure-button remove" id="custom_box_image_upload_remove_btn"

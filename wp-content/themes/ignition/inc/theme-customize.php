...
class MyTheme_Customize {
	...
	public static function header_output() {
		...
		<style type="text/css"><?php
			...
			self::generate_css( '.cnt article p', 'border', '0px', '' );

			self::generate_css( '.product.woocommerce.add_to_cart_inline a.button.product_type_simple.ajax_add_to_cart', 'background-color', 'thrivetheme_white', '' );
			self::generate_css( '.product.woocommerce.add_to_cart_inline a.button.product_type_simple.ajax_add_to_cart', 'border-color', 'thrivetheme_link_color', '' );
			self::generate_css( '.product.woocommerce.add_to_cart_inline a.button.product_type_simple.ajax_add_to_cart', 'color', 'thrivetheme_link_color', '' );
			self::generate_css( '.product.woocommerce.add_to_cart_inline a.button.product_type_simple.ajax_add_to_cart:hover', 'background-color', 'thrivetheme_link_color', '' );

			self::generate_css( '.woocommerce p.return-to-shop a.button.wc-backward', 'border-color', 'thrivetheme_link_color', '' );
			self::generate_css( '.woocommerce p.return-to-shop a.button.wc-backward', 'color', 'thrivetheme_link_color', '' );
			self::generate_css( '.woocommerce p.return-to-shop a.button.wc-backward:hover', 'background', 'thrivetheme_link_color', '' );
			self::generate_css( '.woocommerce p.return-to-shop a.button.wc-backward:hover', 'color', 'thrivetheme_white', '', '', 1 );

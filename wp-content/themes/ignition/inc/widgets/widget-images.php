...
class Thrive_Images_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'widget_thrive_images',
			'description' => __( 'Thrive Latest Images Widget', 'thrive' )
		);
	...
	function form( $instance ) {
		...
		<p><label
				for="<?php echo esc_attr( $this->get_field_id( 'no_images' ) ); ?>"><?php _e( 'Number of images:', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'no_images' ) ); ?>"
			       name="<?php echo esc_attr( $this->get_field_name( 'no_images' ) ); ?>" type="text"
			       value="<?php echo esc_attr( $no_images ); ?>"/></p>

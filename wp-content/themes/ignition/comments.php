	...
	<article id="comments">
		<div class="awr">
			<?php if ( comments_open() && ! post_password_required() ) : ?>
				<div class="ctb">
					<h5><span
							class="txt_thrive_link_to_comments"><?php _e( "Click Here to Leave a Comment Below", 'thrive' ); ?></span>
					</h5>
				</div>
			<?php endif; ?>
			...
			<?php if ( comments_open() && ! post_password_required() ) : ?>
				...
				<div class="lrp" id="thrive_container_form_add_comment">
					...
					<form action="<?php echo get_option( 'siteurl' ); ?>/wp-comments-post.php" method="post"
						...
						<?php endif; ?>
						<textarea id="comment" placeholder="<?php _e( "Comment", 'thrive' ); ?>" name="comment"

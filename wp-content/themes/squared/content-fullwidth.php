...
<article>
	...
	<div class="awr lnd">
		...
		<?php if ( $options['featured_image_style'] == "wide" && $featured_image ): ?>
			<div class="fwit"><a href="<?php the_permalink(); ?>" class="psb"> <img src="<?php echo $featured_image; ?>"
			...
			<ul>
				<?php if ( isset( $options['meta_author_name'] ) && $options['meta_author_name'] == 1 ): ?>
					<li style="<?php echo $li_width_style; ?>"><a
							href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php echo $display_name; ?></a>
					</li>
				<?php endif; ?>

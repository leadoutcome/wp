...
ThriveThemeOptions.display_featured_image_title_bg_type = function () {
    ...
    if (_selected_cta_val == "image") {
        ...
        jQuery(".thrive_featured_title_bg_img_static").parents("tr").show();
        jQuery(".thrive_featured_title_bg_img_full_height").parents("tr").show();
        jQuery("#thrive_theme_options_featured_title_bg_img_trans").parents("tr").show();

    } else {
        jQuery("#thrive_theme_options_featured_title_bg_solid_color").parents("tr").show();
        jQuery(".thrive_featured_title_bg_img_static").parents("tr").hide();
        jQuery(".thrive_featured_title_bg_img_full_height").parents("tr").hide();
        jQuery("#thrive_theme_options_featured_title_bg_img_trans").parents("tr").hide();
    }
};

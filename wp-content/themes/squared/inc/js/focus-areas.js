...
ThriveFocusOptions.display_fields = {
    template1: ["container-focus-template", "container-focus-color", "container-heading-text", "container-optin", "container-button-text"],
    template2: ["container-focus-template", "container-focus-color", "container-heading-text", "container-button-link", "container-new-tab"],
    template4: ["container-focus-color", "container-button-color", "container-button-text", "container-heading-text", 'container-subheading-text', "container-focus-image", "container-optin"],
    template5: ["container-button-text", "container-button-color", "container-heading-text", 'container-subheading-text', "container-focus-image", "container-optin"],
...
ThriveFocusOptions.hide_fields = {
    ...
    template4: ["postdivrich", "postdivrich", "container-spam-disclaimer", "container-button-link", "container-new-tab", "container-custom-text", "container-button-color"],
    template5: ["postdivrich", "postdivrich", "container-spam-disclaimer", "container-button-link", "container-new-tab", "container-custom-text", "container-focus-color"],
...
ThriveFocusOptions.all_fields = ["container-focus-color", "postdivrich", "container-heading-text", 'container-subheading-text', "container-button-text", "container-button-color",
    "container-spam-disclaimer", "container-focus-image", "container-button-link", "container-new-tab", "container-optin", "container-custom-text"];
/*
...
jQuery(document).ready(function () {
    ...
    jQuery("#thrive_meta_focus_display_sel_categories").on("change", function (e) {
        var temp_cat_values = JSON.stringify(jQuery("#thrive_meta_focus_display_sel_categories").val());
    ...
    ThriveFocusOptions.hideUnsuportedFields(jQuery(".opt_in_template.selected").find(".this_template").val());
    ...
    jQuery(".opt_in_template").click(function () {
        ...
        ThriveFocusOptions.hideUnsuportedFields(this_template_number);
    });
...
ThriveFocusOptions.hideUnsuportedFields = function (template_number) {
    var $location = jQuery( '#thrive_meta_focus_display_location' );
    jQuery( 'option', $location ).prop( 'disabled', false );

	function disable_option( value ) {
		$location.find( 'option[value="' + value + '"]' ).prop( 'disabled', true );
		$location.val( $location.find( 'option:not(:disabled)' ).first().val() ).trigger( 'change' );
	}

    if ( template_number == 4 || template_number == 5 ) {
    	disable_option( 'top' );
    }

    if ( template_number == 1 || template_number == 2 ) {
    	disable_option( 'bottom' );
    }
}

...
class MyTheme_Customize {
	...
	public static function header_output() {
		...
		<style type="text/css">.wp-video-shortcode {
			...
			self::generate_css( '.cnt .sAs .twr', 'background', 'background_color', '' );
			...
			self::generate_css( '.cnt, .cnt article p, .bp-t, .tve-woocommerce .product p, .tve-woocommerce .products p', 'font-family', 'thrivetheme_body_font' );
			self::generate_css( '.bSe h1, .hru h1, .bSe .entry-title', 'font-size', 'thrivetheme_header_fontsize', '', 'px' );
			...
			// self::generate_css('.brd ul li a', 'color', 'thrivetheme_highlight_color');
			...
			self::generate_css( 'header ul.menu > li.h-cta > a:hover', 'border-color', 'thrivetheme_highlight_hover_background_color', '' );
			?></style>
		<?php
	}
	...
	public static function generate_css( $selector, $style, $mod_name, $prefix = '', $postfix = '', $echo = true ) {
		...
		if ( ( $selector == "header ul.menu > li.h-cta > a" || $selector == "header ul.menu > li.h-cta > a:hover" ) && $style == "border-color" ) {
			$darker_color = _thrive_colour_creator( $mod, - 10 );
			$mod          = $darker_color;
		}

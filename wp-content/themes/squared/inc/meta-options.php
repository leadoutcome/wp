...
function thrive_meta_post_options( $post ) {
	...
	$value_post_title_bg_type            = get_post_meta( $post->ID, '_thrive_meta_post_title_bg_type', true );
	$value_post_title_bg_solid_color     = get_post_meta( $post->ID, '_thrive_meta_post_title_bg_solid_color', true );
	$value_post_title_bg_img_trans       = get_post_meta( $post->ID, '_thrive_meta_post_title_bg_img_trans', true );
	$value_post_title_bg_img_static      = get_post_meta( $post->ID, '_thrive_meta_post_title_bg_img_static', true );
	$value_post_title_bg_img_full_height = get_post_meta( $post->ID, '_thrive_meta_post_title_bg_img_full_height', true );
...
function thrive_meta_page_options( $page ) {
	...
	$value_post_title_bg_type            = get_post_meta( $page->ID, '_thrive_meta_post_title_bg_type', true );
	$value_post_title_bg_solid_color     = get_post_meta( $page->ID, '_thrive_meta_post_title_bg_solid_color', true );
	$value_post_title_bg_img_trans       = get_post_meta( $page->ID, '_thrive_meta_post_title_bg_img_trans', true );
	$value_post_title_bg_img_static      = get_post_meta( $page->ID, '_thrive_meta_post_title_bg_img_static', true );
	$value_post_title_bg_img_full_height = get_post_meta( $page->ID, '_thrive_meta_post_title_bg_img_full_height', true );
...
function thrive_meta_focusarea_options( $page ) {
	...
	$focus_templates = array( '1' => 'Template 1', '2' => 'Template 2', '4' => 'Template 4', '0' => 'Custom Template' );
...
function thrive_meta_focusarea_display_options( $page ) {
	...
	$value_focus_display_between_posts = get_post_meta( $page->ID, '_thrive_meta_focus_display_between_posts', true );
...
function _thrive_save_post_options( $post_data ) {
	...
	$thrive_meta_post_breadcrumbs      = ( $post_data['thrive_meta_post_breadcrumbs'] );
	...
	$thrive_meta_post_title_bg_type            = ( $post_data['thrive_meta_post_title_bg_type'] );
	$thrive_meta_post_title_bg_solid_color     = ( $post_data['thrive_meta_post_title_bg_solid_color'] );
	$thrive_meta_post_title_bg_img_trans       = ( $post_data['thrive_meta_post_title_bg_img_trans'] );
	$thrive_meta_post_title_bg_img_static      = ( $post_data['thrive_meta_post_title_bg_img_static'] );
	$thrive_meta_post_title_bg_img_full_height = ( $post_data['thrive_meta_post_title_bg_img_full_height'] );
	...
	add_post_meta( $post_ID, '_thrive_meta_post_title_bg_type', $thrive_meta_post_title_bg_type, true ) or
	update_post_meta( $post_ID, '_thrive_meta_post_title_bg_type', $thrive_meta_post_title_bg_type );

	add_post_meta( $post_ID, '_thrive_meta_post_title_bg_solid_color', $thrive_meta_post_title_bg_solid_color, true ) or
	update_post_meta( $post_ID, '_thrive_meta_post_title_bg_solid_color', $thrive_meta_post_title_bg_solid_color );

	add_post_meta( $post_ID, '_thrive_meta_post_title_bg_img_trans', $thrive_meta_post_title_bg_img_trans, true ) or
	update_post_meta( $post_ID, '_thrive_meta_post_title_bg_img_trans', $thrive_meta_post_title_bg_img_trans );

	add_post_meta( $post_ID, '_thrive_meta_post_title_bg_img_static', $thrive_meta_post_title_bg_img_static, true ) or
	update_post_meta( $post_ID, '_thrive_meta_post_title_bg_img_static', $thrive_meta_post_title_bg_img_static );

	add_post_meta( $post_ID, '_thrive_meta_post_title_bg_img_full_height', $thrive_meta_post_title_bg_img_full_height, true ) or
	update_post_meta( $post_ID, '_thrive_meta_post_title_bg_img_full_height', $thrive_meta_post_title_bg_img_full_height );
...
function _thrive_save_page_options( $post_data ) {
	...
	add_post_meta( $page_ID, '_thrive_meta_post_title_bg_type', $thrive_meta_post_title_bg_type, true ) or
	update_post_meta( $page_ID, '_thrive_meta_post_title_bg_type', $thrive_meta_post_title_bg_type );

	add_post_meta( $page_ID, '_thrive_meta_post_title_bg_solid_color', $thrive_meta_post_title_bg_solid_color, true ) or
	update_post_meta( $page_ID, '_thrive_meta_post_title_bg_solid_color', $thrive_meta_post_title_bg_solid_color );

	add_post_meta( $page_ID, '_thrive_meta_post_title_bg_img_trans', $thrive_meta_post_title_bg_img_trans, true ) or
	update_post_meta( $page_ID, '_thrive_meta_post_title_bg_img_trans', $thrive_meta_post_title_bg_img_trans );

	add_post_meta( $page_ID, '_thrive_meta_post_title_bg_img_static', $thrive_meta_post_title_bg_img_static, true ) or
	update_post_meta( $page_ID, '_thrive_meta_post_title_bg_img_static', $thrive_meta_post_title_bg_img_static );

	add_post_meta( $page_ID, '_thrive_meta_post_title_bg_img_full_height', $thrive_meta_post_title_bg_img_full_height, true ) or
	update_post_meta( $page_ID, '_thrive_meta_post_title_bg_img_full_height', $thrive_meta_post_title_bg_img_full_height );
...
function _thrive_save_focus_options( $post_data ) {
	...
	$thrive_meta_focus_display_between_posts = sanitize_text_field( $post_data['thrive_meta_focus_display_between_posts'] );
	...
	add_post_meta( $page_ID, '_thrive_meta_focus_display_between_posts', $thrive_meta_focus_display_between_posts, true ) or
	update_post_meta( $page_ID, '_thrive_meta_focus_display_between_posts', $thrive_meta_focus_display_between_posts );

...
function thrive_theme_options_init() {
	...
	//add_settings_field('social_add_like_btn', $options_titles['social_add_like_btn'], 'thrive_settings_field_social_add_like_btn', 'theme_social_advanced_options', 'social_advanced_settings', $options);add_settings_field('social_site_meta_enable', $options_titles['social_site_meta_enable'], 'thrive_settings_field_social_site_meta_enable', 'theme_social_sharing_data_options', 'social_sharing_data', $options);
...
function thrive_theme_options_validate( $input ) {
	...
	if ( isset( $input['featured_title_bg_type'] ) ) {
		$output['featured_title_bg_type'] = $input['featured_title_bg_type'];
	}
	if ( isset( $input['featured_title_bg_solid_color'] ) ) {
		$output['featured_title_bg_solid_color'] = $input['featured_title_bg_solid_color'];
	}
	if ( isset( $input['featured_title_bg_img_static'] ) ) {
		$output['featured_title_bg_img_static'] = $input['featured_title_bg_img_static'];
	}
	if ( isset( $input['featured_title_bg_img_full_height'] ) ) {
		$output['featured_title_bg_img_full_height'] = $input['featured_title_bg_img_full_height'];
	}
	if ( isset( $input['featured_title_bg_img_trans'] ) ) {
		$output['featured_title_bg_img_trans'] = $input['featured_title_bg_img_trans'];
	}
...
function thrive_theme_page_templates_options_validate( $input ) {
	//$defaults = thrive_get_page_templates_default_options();

	if ( ! isset( $input['privacy_tpl_website'] ) ) {
		return array(
			'privacy_tpl_website' => thrive_get_theme_options( "privacy_tpl_website" ),
			'privacy_tpl_address' => thrive_get_theme_options( "privacy_tpl_address" ),
			'privacy_tpl_company' => thrive_get_theme_options( "privacy_tpl_company" ),
			'privacy_tpl_contact' => thrive_get_theme_options( "privacy_tpl_contact" ),
		);
	}

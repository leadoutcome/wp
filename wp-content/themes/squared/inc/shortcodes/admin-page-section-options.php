...
<div class="tt-sc-options-container">
	...
	<table id="thrive_shortcode_options_container" class="form-table postEdit">
		<tr>
			...
			<td>
				<input type="radio" name="thrive_shortcode_bg_type" class="thrive_shortcode_bg_type" value="solid"
				       checked/>
				<?php _e( "Solid", 'thrive' ); ?>
				<input type="radio" name="thrive_shortcode_bg_type" class="thrive_shortcode_bg_type"
				       value="image"/> <?php _e( "Image", 'thrive' ); ?>
				<input type="radio" name="thrive_shortcode_bg_type" class="thrive_shortcode_bg_type"
				       value="pattern"/> <?php _e( "Pattern", 'thrive' ); ?>
			</td>
		</tr>
		...
		<tr id="thrive_shortcode_container_bg_image" style="display: none;">
			...
			<td>
				<input type="text" class="adminHeightInput" id="thrive_shortcode_option_image"
				       name="thrive_shortcode_option_image"/>
				<input type="button" class="thrive_upload pure-button upload" id="thrive_shortcode_option_image_btn"
				       value="<?php _e( "Upload image", 'thrive' ); ?>"/>
				<input type="button" class="pure-button remove" id="thrive_shortcode_option_remove_image_btn"
				       value="<?php _e( "Remove", 'thrive' ); ?>"/> <br/><br/>

				<input type="radio" class="radio_img_static" value="default" name="radio_img_static"
				       checked/> <?php _e( "Default", 'thrive' ); ?>
				<input type="radio" class="radio_img_static" value="static"
				       name="radio_img_static"/> <?php _e( "Static image", 'thrive' ); ?>
				<br/><br/>
				<?php _e( "Show full image height", 'thrive' ); ?>
				<input type="radio" class="radio_img_fullheight" value="off" name="radio_img_fullheight"
				       checked/> <?php _e( "Off", 'thrive' ); ?>
				<input type="radio" class="radio_img_fullheight" value="on"
				       name="radio_img_fullheight"/> <?php _e( "On", 'thrive' ); ?>
			</td>
		</tr>
		...
		<tr id="thrive_shortcode_container_bg_pattern" style="display: none;">
			...
			<td>
				...
				<input type="button" class="thrive_upload pure-button upload" id="thrive_shortcode_option_pattern_btn"
				       value="<?php _e( "Upload", 'thrive' ); ?>"/>
				<input type="button" class="pure-button remove" id="thrive_shortcode_option_remove_pattern_btn"
				       value="<?php _e( "Remove", 'thrive' ); ?>"/>
				<br/>
	...
	jQuery( document ).ready( function () {
		...
		jQuery( ".thrive_shortcode_bg_type" ).click( function () {
			if ( jQuery( this ).val() === "solid" ) {
				jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_container_bg_solid" ).show();
				jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_container_bg_image" ).hide();
				jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_container_bg_pattern" ).hide();
			} else if ( jQuery( this ).val() === "image" ) {
				jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_container_bg_image" ).show();
				jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_container_bg_solid" ).hide();
				jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_container_bg_pattern" ).hide();
			} else {
				jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_container_bg_pattern" ).show();
				jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_container_bg_solid" ).hide();
				jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_container_bg_image" ).hide();
			}
		} );
		...
		jQuery( "#thrive_shortcode_btn_insert" ).click( function () {
			...
			var sc_options = {
				'color': jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_option_color" ).val(),
				'shadow': jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_option_shadow" ).val(),
				'image': jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_option_image" ).val(),
				'pattern': jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_option_pattern" ).val(),
				'textstyle': jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_option_text_style" ).val(),
				'template': jQuery( ".tt-sc-options-container" ).find( "#thrive_shortcode_hidden_template_option" ).val(),
				'position': jQuery( ".tt-sc-options-container" ).find( ".thrive_shortcode_position:checked" ).val(),
				'padding_top': jQuery( ".tt-sc-options-container" ).find( "#chk_add_padding_top" ).prop( 'checked' ),
				'padding_bottom': jQuery( ".tt-sc-options-container" ).find( "#chk_add_padding_bottom" ).prop( 'checked' ),
				'img_static': jQuery( ".tt-sc-options-container" ).find( ".radio_img_static:checked" ).val(),
				'img_fullheight': jQuery( ".tt-sc-options-container" ).find( ".radio_img_fullheight:checked" ).val()
			};

			var bg_type = jQuery( ".tt-sc-options-container" ).find( ".thrive_shortcode_bg_type:checked" ).val();
			var sc_text = "";
			var sc_shadow_txt = "";

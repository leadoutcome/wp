<?php
$adminCreateNewOptinUrl = admin_url( 'post-new.php?post_type=thrive_optin' );
?>
...
<div class="thrive_options_panel">
	...
	<div id='container-optin' class="thrive_option_container">
		<table class="form-table focusEdit">
			...
			<td>
				<a href="<?php echo $adminCreateNewOptinUrl; ?>" class="button button-primary"
				   id="add_mailing_list"><?php _e( "Connect to a New Mailing List", 'thrive' ); ?></a>
			</td>
		</table>
	</div>

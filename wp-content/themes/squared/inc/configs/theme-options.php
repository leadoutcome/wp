...
function thrive_get_default_customizer_options( $color_scheme = null ) {
	...
	switch ( $color_scheme ) {
		case 'green':
			$default_values = array(
				'thrivetheme_link_color'                       => '#34dd39',
				'thrivetheme_highlight_color'                  => '#34dd39',
				'thrivetheme_menu_highlight_color'             => '#34dd39',
				'thrivetheme_headline_color'                   => '#343434',
				'thrivetheme_bodytext_color'                   => '#343434',
				'thrivetheme_header_font'                      => '//fonts.googleapis.com/css?family=Lato:400,700&subset=latin,latin-ext',
				'thrivetheme_body_font'                        => '//fonts.googleapis.com/css?family=Lato:400,700&subset=latin,latin-ext',
				'thrivetheme_header_fontsize'                  => '47',
				'thrivetheme_body_fontsize'                    => '17',
				'thrivetheme_body_lineheight'                  => '1.6',
				'thrivetheme_default_highlight'                => '#34dd39 #4de151',
				'thrivetheme_highlight_background_color'       => '#34dd39',
				'thrivetheme_highlight_link_color'             => '#FFFFFF',
				'thrivetheme_highlight_hover_background_color' => '#4de151',
				'thrivetheme_highlight_hover_link_color'       => '#FFFFFF'
			);
			break;
		case 'red':
			$default_values = array(
				'thrivetheme_link_color'                       => '#f63d3d',
				'thrivetheme_highlight_color'                  => '#f63d3d',
				'thrivetheme_menu_highlight_color'             => '#f63d3d',
				'thrivetheme_headline_color'                   => '#343434',
				'thrivetheme_bodytext_color'                   => '#343434',
				'thrivetheme_header_font'                      => '//fonts.googleapis.com/css?family=Lato:400,700&subset=latin,latin-ext',
				'thrivetheme_body_font'                        => '//fonts.googleapis.com/css?family=Lato:400,700&subset=latin,latin-ext',
				...
				'thrivetheme_body_fontsize'                    => '17',
				'thrivetheme_body_lineheight'                  => '1.6',
				'thrivetheme_default_highlight'                => '#f63d3d #f75555',
				'thrivetheme_highlight_background_color'       => '#f63d3d',
				'thrivetheme_highlight_link_color'             => '#FFFFFF',
				'thrivetheme_highlight_hover_background_color' => '#f75555',
				'thrivetheme_highlight_hover_link_color'       => '#FFFFFF'
			);
			break;
		case 'blue':
			$default_values = array(
				'thrivetheme_link_color'                       => '#a0d8f8',
				'thrivetheme_highlight_color'                  => '#a0d8f8',
				'thrivetheme_menu_highlight_color'             => '#a0d8f8',
				'thrivetheme_headline_color'                   => '#343434',
				'thrivetheme_bodytext_color'                   => '#343434',
				'thrivetheme_header_font'                      => '//fonts.googleapis.com/css?family=Lato:400,700&subset=latin,latin-ext',
				'thrivetheme_body_font'                        => '//fonts.googleapis.com/css?family=Lato:400,700&subset=latin,latin-ext',
				...
				'thrivetheme_body_fontsize'                    => '17',
				'thrivetheme_body_lineheight'                  => '1.6',
				'thrivetheme_default_highlight'                => '#a0d8f8 #acddf9',
				'thrivetheme_highlight_background_color'       => '#a0d8f8',
				'thrivetheme_highlight_link_color'             => '#FFFFFF',
				'thrivetheme_highlight_hover_background_color' => '#acddf9',
				'thrivetheme_highlight_hover_link_color'       => '#FFFFFF'
			);
			break;
		case 'orange':
			$default_values = array(
				'thrivetheme_link_color'                       => '#f4c664',
				'thrivetheme_highlight_color'                  => '#f4c664',
				'thrivetheme_menu_highlight_color'             => '#f4c664',
				'thrivetheme_headline_color'                   => '#343434',
				'thrivetheme_bodytext_color'                   => '#343434',
				'thrivetheme_header_font'                      => '//fonts.googleapis.com/css?family=Lato:400,700&subset=latin,latin-ext',
				'thrivetheme_body_font'                        => '//fonts.googleapis.com/css?family=Lato:400,700&subset=latin,latin-ext',
				...
				'thrivetheme_body_fontsize'                    => '17',
				'thrivetheme_body_lineheight'                  => '1.6',
				'thrivetheme_default_highlight'                => '#f4c664 #f5cd77',
				'thrivetheme_highlight_background_color'       => '#f4c664',
				'thrivetheme_highlight_link_color'             => '#FFFFFF',
				'thrivetheme_highlight_hover_background_color' => '#f5cd77',
				'thrivetheme_highlight_hover_link_color'       => '#FFFFFF'
			);
			break;
		case 'purple':
			$default_values = array(
				'thrivetheme_link_color'                       => '#9793ff',
				'thrivetheme_highlight_color'                  => '#9793ff',
				'thrivetheme_menu_highlight_color'             => '#9793ff',
				'thrivetheme_headline_color'                   => '#343434',
				'thrivetheme_bodytext_color'                   => '#343434',
				'thrivetheme_header_font'                      => '//fonts.googleapis.com/css?family=Lato:400,700&subset=latin,latin-ext',
				'thrivetheme_body_font'                        => '//fonts.googleapis.com/css?family=Lato:400,700&subset=latin,latin-ext',
				...
				'thrivetheme_body_fontsize'                    => '17',
				'thrivetheme_body_lineheight'                  => '1.6',
				'thrivetheme_default_highlight'                => '#9793ff #a4a0ff',
				'thrivetheme_highlight_background_color'       => '#9793ff',
				'thrivetheme_highlight_link_color'             => '#FFFFFF',
				'thrivetheme_highlight_hover_background_color' => '#a4a0ff',
				'thrivetheme_highlight_hover_link_color'       => '#FFFFFF'
			);
			break;
		case 'teal':
			$default_values = array(
				'thrivetheme_link_color'                       => '#16b495',
				'thrivetheme_highlight_color'                  => '#16b495',
				'thrivetheme_menu_highlight_color'             => '#16b495',
				'thrivetheme_headline_color'                   => '#343434',
				'thrivetheme_bodytext_color'                   => '#343434',
				'thrivetheme_header_font'                      => '//fonts.googleapis.com/css?family=Lato:400,700&subset=latin,latin-ext',
				'thrivetheme_body_font'                        => '//fonts.googleapis.com/css?family=Lato:400,700&subset=latin,latin-ext',
				...
				'thrivetheme_body_fontsize'                    => '17',
				'thrivetheme_body_lineheight'                  => '1.6',
				'thrivetheme_default_highlight'                => '#16b495 #32bda2',
				'thrivetheme_highlight_background_color'       => '#16b495',
				'thrivetheme_highlight_link_color'             => '#FFFFFF',
				'thrivetheme_highlight_hover_background_color' => '#32bda2',
				'thrivetheme_highlight_hover_link_color'       => '#FFFFFF'
			);
			break;
		default:
	...
	$default_values['thrivetheme_menu_link_color']  = "#e6e6e6";
...
function thrive_get_default_theme_options() {
	...
	$default_theme_options = array(
		...
		'featured_title_bg_type'            => "image",
		'featured_title_bg_solid_color'     => "",
...
//if we're not on a page or an apprentice page set the comments on pages option to 1
	...
	if ( is_singular() && isset( $post_options['_thrive_meta_post_title_bg_type'][0] ) && ( $post_options['_thrive_meta_post_title_bg_type'][0] == "image" || $post_options['_thrive_meta_post_title_bg_type'][0] == "solid" ) ) {
		$display_options['featured_title_bg_type']            = $post_options['_thrive_meta_post_title_bg_type'][0];
		$display_options['featured_title_bg_solid_color']     = $post_options['_thrive_meta_post_title_bg_solid_color'][0];
		$display_options['featured_title_bg_img_static']      = isset( $post_options['_thrive_meta_post_title_bg_img_static'][0] ) ? $post_options['_thrive_meta_post_title_bg_img_static'][0] : $display_options['featured_title_bg_img_static'];
		$display_options['featured_title_bg_img_full_height'] = isset( $post_options['_thrive_meta_post_title_bg_img_full_height'][0] ) ? $post_options['_thrive_meta_post_title_bg_img_full_height'][0] : $display_options['featured_title_bg_img_full_height'];

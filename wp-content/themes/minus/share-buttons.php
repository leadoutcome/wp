...
<div class="ssf <?php echo $options['enable_floating_icons'] != 1 ? 'apsf' : ''; ?>">
	...
	<div class="scfm">
		...
		<?php if ( $options['enable_twitter_button'] == 1 ):
			...
			?>
			<div class="ss">
				<a class="tw" href="https://twitter.com/share?text=<?php echo rawurlencode( wp_strip_all_tags( get_the_title() ) ); ?>:&url=<?php echo $current_url; ?><?php echo $twitter_via_user; ?>" onclick="return ThriveApp.open_share_popup(this.href, 545, 433);">
					<span class="awe">&#xf099;</span>
				</a>
			</div>
		<?php endif; ?>

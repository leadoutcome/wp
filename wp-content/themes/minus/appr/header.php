<?php
$post_options      = thrive_get_options_for_post( get_the_ID() );
...
<head>
	...
	<?php endif; ?>
	<?php if ( isset( $post_options['custom_css'] ) && $post_options['custom_css'] != "" ): ?>
		<style type="text/css"><?php echo $post_options['custom_css']; ?></style>
	<?php endif; ?>

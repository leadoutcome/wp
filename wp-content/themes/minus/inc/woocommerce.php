...
function thrive_woo_wrapper_start() {
	...
	if ( $sidebar_is_active ) {
		...
		$section_class = "bSe fullWidth";
	}

	$thrive_woo_open_wrapper .= '<section class="' . $section_class . '"><article><div class="awr">';
...
function thrive_woo_wrapper_end() {
	...
	//before closing the WOO wrapper display SS icons
	thrive_include_social_icons();
...
/**
 * Based on thrive options display SS icons
 */

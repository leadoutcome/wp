...
function thrive_theme_options_init() {
	...
	add_settings_section( 'blog_layout_settings', __( 'Blog layout', 'thrive' ), '__return_false', 'theme_blog_layout_options' );
	add_settings_field( 'blog_layout', $options_titles['blog_layout'], 'thrive_settings_field_blog_layout', 'theme_blog_layout_options', 'blog_layout_settings', $options );
}
...
function thrive_settings_field_featured_image_style( $options ) {
	...
	$checked_4 = ( $options['featured_image_style'] == 'round' ) ? "checked" : "";
	...
	echo "<input type='radio' name='thrive_theme_options[featured_image_style]' value='round' $checked_4 /> " . __( 'Round', 'thrive' ) . "";

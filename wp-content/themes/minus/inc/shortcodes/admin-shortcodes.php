...
function thrive_print_shortcodes() {
	...
	<script type="text/javascript">
		...
		/*var thrive_shortcodes = ['Button', 'BlankSpace', 'ContentContainer', 'ContentBox', 'CustomMenu', 'Borderless', 'Code', 'CustomFont', 'Divider Line', 'FollowMe', 'Phone','Accordion',
		 'GMaps', 'Grid', 'Tabs', 'Toggle', 'PageSection', 'Pullquote', 'PostsList', 'PostsGallery', 'Price', 'Testimonal', 'VideoSection', 'Optin', 'ResponsiveVideo'];*/

...
jQuery(document).ready(function() {
    ...
    jQuery("#thrive_theme_hide_cats_from_blog_sel").on("change", function(e) {
        var temp_cat_values = JSON.stringify(jQuery("#thrive_theme_hide_cats_from_blog_sel").val());
    ...
    jQuery(".thrive_theme_options_blog_layout_radio").change(ThriveThemeOptions.check_blog_layout_fields);
    
    ThriveThemeOptions.check_blog_layout_fields();
    ...
    jQuery("#sel_thrive_theme_options_related_ignore_cats").on("change", function(e) {
        var temp_cat_values = JSON.stringify(jQuery("#sel_thrive_theme_options_related_ignore_cats").val());
    ...
    jQuery("#sel_thrive_theme_options_related_ignore_tags").on("change", function(e) {
        var temp_tag_values = JSON.stringify(jQuery("#sel_thrive_theme_options_related_ignore_tags").val());
    ...
    jQuery("#appr_logo_type_image").click(ThriveThemeOptions.display_appr_logo_fields);
    jQuery("#appr_logo_type_text").click(ThriveThemeOptions.display_appr_logo_fields);
    jQuery("#appr_different_logo_on").click(ThriveThemeOptions.display_appr_logo_fields);
    jQuery("#appr_different_logo_off").click(ThriveThemeOptions.display_appr_logo_fields);    
    ThriveThemeOptions.display_appr_logo_fields();
...
ThriveThemeOptions.check_blog_layout_fields = function() {
    var _current_option = jQuery(".thrive_theme_options_blog_layout_radio:checked").val();
    if (_current_option === "grid_full_width" || _current_option === "grid_sidebar") {
        jQuery("#thrive_container_featured_image_options").find("tr").first().hide();
    } else {
        jQuery("#thrive_container_featured_image_options").find("tr").first().show();
    }
};
...
ThriveThemeOptions.display_appr_logo_fields = function() {

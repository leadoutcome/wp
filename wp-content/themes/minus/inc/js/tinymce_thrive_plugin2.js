        ...
        init: function(ed, url) {
            ed.onNodeChange.add(
                ...
                {                   
                    ...
                    var _element_id = "content_thriveShortcodes2_text";
                    if (jQuery("#thrive_meta_focus_subheading_text_thriveShortcodes2").length > 0) {
                        _element_id = "thrive_meta_focus_subheading_text_thriveShortcodes2";
                    }

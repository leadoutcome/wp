			...
			<div class="thrive-admin-subcontainer" id="thrive-admin-subcontainer-general-options">
				<table class="form-table">
					<tr>
						...
						<td>
							<input type="radio" value="1" name="thrive_meta_show_post_title" <?php if ( $value_show_post_title == 1 ): ?>checked<?php endif ?> /> Show
							<input type="radio" value="0" name="thrive_meta_show_post_title" <?php if ( $value_show_post_title == 0 ): ?>checked<?php endif ?> /> Hide
						</td>
					</tr>
					<tr>
						<th scope="row">
						...
						<td>
							<input type="radio" value="on" name="thrive_meta_post_breadcrumbs" <?php if ( $value_post_bradcrumbs == "on" ): ?>checked<?php endif ?> /> On
							<input type="radio" value="default" name="thrive_meta_post_breadcrumbs" <?php if ( $value_post_bradcrumbs == "default" ): ?>checked<?php endif ?> /> Default
							<input type="radio" value="off" name="thrive_meta_post_breadcrumbs" <?php if ( $value_post_bradcrumbs == "off" ): ?>checked<?php endif ?> /> Off
						</td>
					</tr>
					<tr>
						<th scope="row">
						...
						<td>
							<input type="radio" value="default" name="thrive_meta_post_featured_image" <?php if ( $value_post_featured_image == "default" ): ?>checked<?php endif ?> /> Default
							<input type="radio" value="thumbnail" name="thrive_meta_post_featured_image" <?php if ( $value_post_featured_image == "thumbnail" ): ?>checked<?php endif ?> /> Thumbnail
							<input type="radio" value="wide" name="thrive_meta_post_featured_image" <?php if ( $value_post_featured_image == "wide" ): ?>checked<?php endif ?> /> Wide
							<input type="radio" value="round" name="thrive_meta_post_featured_image" <?php if ( $value_post_featured_image == "round" ): ?>checked<?php endif ?> /> Round
							<input type="radio" value="off" name="thrive_meta_post_featured_image" <?php if ( $value_post_featured_image == "off" ): ?>checked<?php endif ?> /> No featured image
						</td>
					</tr>
					<tr>
						<th scope="row">
			...
			<div class="thrive-admin-subcontainer" id="thrive-admin-subcontainer-focus-areas">
				<table class="form-table">
					<tr>
						...
						<td>
							<input type='radio' value='default' name='thrive_meta_post_focus_area_top' <?php if ( $value_post_focus_area_top == "default" || $value_post_focus_area_top == "" ): ?>checked<?php endif; ?> /> Default
							<input type='radio' value='hide' name='thrive_meta_post_focus_area_top' <?php if ( $value_post_focus_area_top == "hide" ): ?>checked<?php endif; ?> /> Hide
							<input type='radio' value='custom' name='thrive_meta_post_focus_area_top' <?php if ( $value_post_focus_area_top != "default" && $value_post_focus_area_top != "hide" && $value_post_focus_area_top != "" ): ?>checked<?php endif; ?> /> Custom

							<select name='thrive_meta_post_focus_area_top_select'>
								<?php foreach ( $queryFocusAreas->get_posts() as $p ): ?>
									<option value='<?php echo $p->ID ?>' <?php if ( $value_post_focus_area_top == $p->ID ): ?>selected<?php endif; ?>><?php echo $p->post_title; ?></option>
								<?php endforeach; ?>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type='radio' value='default' name='thrive_meta_post_focus_area_bottom' <?php if ( $value_post_focus_area_bottom == "default" || $value_post_focus_area_bottom == "" ): ?>checked<?php endif; ?> /> Default
							<input type='radio' value='hide' name='thrive_meta_post_focus_area_bottom' <?php if ( $value_post_focus_area_bottom == "hide" ): ?>checked<?php endif; ?> /> Hide
							<input type='radio' value='custom' name='thrive_meta_post_focus_area_bottom' <?php if ( $value_post_focus_area_bottom != "default" && $value_post_focus_area_bottom != "hide" && $value_post_focus_area_bottom != "" ): ?>checked<?php endif; ?> /> Custom

							<select name='thrive_meta_post_focus_area_bottom_select'>
								<?php foreach ( $queryFocusAreas->get_posts() as $p ): ?>
									<option value='<?php echo $p->ID ?>' <?php if ( $value_post_focus_area_bottom == $p->ID ): ?>selected<?php endif; ?>><?php echo $p->post_title; ?></option>
								<?php endforeach; ?>
							</select>
						</td>
					</tr>

...
<div class="option_tabs left">
	<div class="thrive-admin-submenu">
		...
		<a id="thrive-link-performance-options"
		   rel="performance-options"><?php _e( "Performance", 'thrive' ); ?></a>
...
<div class="option_window left">
	<form action="options.php" id="thrive-options-form" method="post">
		<div class="options-container">
			<div id="thrive-admin-container">
				...
				<div class="thrive-admin-subcontainer" id="thrive-admin-subcontainer-blog-options">
					<?php
					settings_fields( 'thrive_options' );
					do_settings_sections( 'theme_blog_layout_options' );
					?>
					<div id="thrive_container_featured_image_options">
						<?php
				...
				<div class="thrive-admin-subcontainer" id="thrive-admin-subcontainer-related-options">
					<?php if ( $related_posts_enabled != 1 ): ?>
						...
						<input type="button" id="theme_options_enable_related_posts" value="<?php _e( "Enable this Feature", 'thrive' ); ?>" class="thrive_options pure-button upload"/>
					<?php else: ?>
						<?php
						settings_fields( 'thrive_options' );
						...
						<table class="form-table">
							<tr>
								<th scope="row">
									<input type="button" id="thrive_btn_generate_related_posts" value="<?php _e( 'Map relations for all existing posts', 'thrive' ); ?>" class="button"/>
								</th>
								<td><span id="thrive_label_loading_generate_related_posts" style="display:none;"><?php _e( "Please wait, this may take a while...", 'thrive' ); ?></span></td>
							</tr>
						</table>
						<input type="button" id="theme_options_disable_related_posts" value="<?php _e( "Disable this feature", 'thrive' ); ?>" class="thrive_options pure-button clear-field remove"/>
					<?php endif; ?>
					<?php do_settings_sections( 'theme_related_box_options' ); ?>
					<input type="hidden" value="<?php echo $related_posts_enabled; ?>" name="thrive_theme_options[related_posts_enabled]" id="theme_options_hidden_related_posts_enabled"/>
				</div>
		...
		<div class="options-container with-button">
			<p class="submit"><input type="button" name="submit_button" id="tt-submit-button" class="button button-primary" value="<?php _e( "Save All Changes", 'thrive' ); ?>"></p>
		</div>
	</form>
</div>
<div class="clear"></div>

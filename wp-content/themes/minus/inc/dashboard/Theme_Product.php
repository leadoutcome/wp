...
class Theme_Product extends TVE_Dash_Product_Abstract {
	...
	public function __construct( $data = array() ) {
		...
		$this->description = __( 'An elegant, minimal theme, suitable for many purposes.', 'thrive' );
		...
		$this->moreLinks = array(
			...
			'tutorials' => array(
				...
				'href'       => 'https://thrivethemes.com/members/minus/',
				'target'     => '_blank',
			...
			'support'   => array(
				...
				'href'       => 'https://thrivethemes.com/forums/forum/all-themes/minus/',
				'target'     => '_blank',

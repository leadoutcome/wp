...
class Thrive_Follow_Widget extends WP_Widget {
					...
					<ul>
						...
						foreach ( $items as $key => $item ):
							...
							<li class="sm_icons">
								...
								<?php endif; ?>
								<a <?php if ( $item['type'] == "dribble" || $item['type'] == "rss" || $item['type'] == 'xing' ): ?>href="<?php echo $item['url']; ?>"<?php endif; ?> class="sm <?php echo $item['a_class'] . " " . $item['col_class'] ?>" rel="<?php echo $item['type']; ?>">
									<span class="awe"><?php echo $item['span_content']; ?></span>
								</a>
							</li>
						<?php endforeach; ?>
					</ul>
	...
	function _build_items_array( $instance ) {
		...
		if ( isset( $instance['instagram_active'] ) && $instance['instagram_active'] == 1 && $instance['instagram_url'] && $instance['instagram_url'] != "" ) {
			$items[] = array( 'type' => 'instagram', 'url' => $instance['instagram_url'], 'a_class' => 'is', 'col_class' => 'sm-1col', 'span_content' => "&#xf16d;" );
		}
		if ( isset( $instance['xing_active'] ) && $instance['xing_active'] == 1 && $instance['xing_url'] && $instance['xing_url'] != "" ) {
			$items[] = array( 'type' => 'xing', 'url' => $instance['xing_url'], 'a_class' => 'xi', 'col_class' => 'sm-1col', 'span_content' => "&#xf168;" );
		}
	...
	function form( $instance ) {
		...
		<p>
			...
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'twitter_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'twitter_active' ) ); ?>" <?php if ( $twitter_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'twitter_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'twitter_active' ) ); ?>" <?php if ( $twitter_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'twitter_url' ) ); ?>"><?php _e( 'Twitter username:', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'twitter_url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'twitter_url' ) ); ?>" type="text" value="<?php echo esc_attr( $twitter_url ); ?>"/></p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'facebook_active' ) ); ?>"><b><?php _e( 'Facebook page', 'thrive' ); ?></b></label> <br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'facebook_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'facebook_active' ) ); ?>" <?php if ( $facebook_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'facebook_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'facebook_active' ) ); ?>" <?php if ( $facebook_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'facebook_url' ) ); ?>"><?php _e( 'Page url:', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'facebook_url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'facebook_url' ) ); ?>" type="text" value="<?php echo esc_attr( $facebook_url ); ?>"/></p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'gprofile_active' ) ); ?>"><b><?php _e( 'Google+ profile', 'thrive' ); ?></b></label> <br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'gprofile_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'gprofile_active' ) ); ?>" <?php if ( $gprofile_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'gprofile_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'gprofile_active' ) ); ?>" <?php if ( $gprofile_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'gprofile_url' ) ); ?>"><?php _e( 'Profile url', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'gprofile_url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'gprofile_url' ) ); ?>" type="text" value="<?php echo esc_attr( $gprofile_url ); ?>"/></p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'gpage_active' ) ); ?>"><b><?php _e( 'Google+ Page', 'thrive' ); ?></b></label> <br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'gpage_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'gpage_active' ) ); ?>" <?php if ( $gpage_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'gpage_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'gpage_active' ) ); ?>" <?php if ( $gpage_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'gpage_url' ) ); ?>"><?php _e( 'Page url:', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'gpage_url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'gpage_url' ) ); ?>" type="text" value="<?php echo esc_attr( $gpage_url ); ?>"/></p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'linkedin_active' ) ); ?>"><b><?php _e( 'LinkedIn', 'thrive' ); ?></b></label> <br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'linkedin_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'linkedin_active' ) ); ?>" <?php if ( $linkedin_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'linkedin_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'linkedin_active' ) ); ?>" <?php if ( $linkedin_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'linkedin_url' ) ); ?>"><?php _e( 'Company or profile URL', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'linkedin_url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'linkedin_url' ) ); ?>" type="text" value="<?php echo esc_attr( $linkedin_url ); ?>"/></p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'dribble_active' ) ); ?>"><b><?php _e( 'Dribble', 'thrive' ); ?></b></label> <br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'dribble_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'dribble_active' ) ); ?>" <?php if ( $dribble_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'dribble_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'dribble_active' ) ); ?>" <?php if ( $dribble_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'dribble_url' ) ); ?>"><?php _e( 'Dribble username:', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'dribble_url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'dribble_url' ) ); ?>" type="text" value="<?php echo esc_attr( $dribble_url ); ?>"/></p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'pinterest_active' ) ); ?>"><b><?php _e( 'Pinterest', 'thrive' ); ?></b></label> <br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'pinterest_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'pinterest_active' ) ); ?>" <?php if ( $pinterest_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'pinterest_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'pinterest_active' ) ); ?>" <?php if ( $pinterest_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'pinterest_url' ) ); ?>"><?php _e( 'Pinterest url:', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'pinterest_url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'pinterest_url' ) ); ?>" type="text" value="<?php echo esc_attr( $pinterest_url ); ?>"/></p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'rss_active' ) ); ?>"><b><?php _e( 'RSS', 'thrive' ); ?></b></label> <br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'rss_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'rss_active' ) ); ?>" <?php if ( $rss_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'rss_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'rss_active' ) ); ?>" <?php if ( $rss_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'rss_url' ) ); ?>"><?php _e( 'RSS Feed URL', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'rss_url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'rss_url' ) ); ?>" type="text" value="<?php echo esc_attr( $rss_url ); ?>"/></p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'youtube_active' ) ); ?>"><b><?php _e( 'Youtube', 'thrive' ); ?></b></label> <br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'youtube_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'youtube_active' ) ); ?>" <?php if ( $youtube_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'youtube_active' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'youtube_active' ) ); ?>" <?php if ( $youtube_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'youtube_url' ) ); ?>"><?php _e( 'Youtube username:', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'youtube_url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'youtube_url' ) ); ?>" type="text" value="<?php echo esc_attr( $youtube_url ); ?>"/></p>
			...
			case 'gpage':
				if ( isset( $instance['gpage_active'] ) && $instance['gpage_active'] == 1 ) {
					...
					<div id="container-follow-gpage">
						<div class='g-follow' data-width="273" data-href="<?php echo $gPageUrl; ?>" data-layout="landscape" data-rel="author" id="follow_me_content_gprofile"></div>
					</div>
			...
			case 'twitter':
				if ( isset( $instance['twitter_active'] ) && $instance['twitter_active'] == 1 ) {
					...
					<div id="container-follow-twitter">
						<a href="<?php echo _thrive_get_social_link( $instance['twitter_url'], 'twitter' ); ?>" class="twitter-follow-button" data-show-count="false">Follow @<?php echo $twitterUsername; ?></a>
					</div>
					<script>jQuery( window ).load( function () {
			...
			case 'pinterest':
				if ( isset( $instance['pinterest_active'] ) && $instance['pinterest_active'] == 1 ) {
					...
					<div id="container-follow-pinterest">
						<a data-pin-do="buttonFollow" href="//www.pinterest.com/<?php echo $instance['pinterest_url'] ?>/"><?php echo $pinterest_user; ?></a>
						<script>
							jQuery( window ).load( function () {
			...
			case 'youtube':
				if ( isset( $instance['youtube_active'] ) && $instance['youtube_active'] == 1 ) {
					...
					<div id="container-follow-youtube">
						<div class="g-ytsubscribe" data-channelid="<?php echo _thrive_get_social_link( $instance['youtube_url'], 'youtube' ); ?>" data-channel="<?php echo _thrive_get_social_link( $instance['youtube_url'], 'youtube' ); ?>" data-layout="full"></div>
						<script>
							jQuery( window ).load( function () {
			...
			case 'instagram':
				if ( isset( $instance['instagram_active'] ) && $instance['instagram_active'] == 1 ) {
					...
					<div id="container-follow-instagram">
						...
						<a target="_blank" href="//instagram.com/<?php echo $instance['instagram_url']; ?>?ref=badge" class="ig-b- ig-b-v-24"><img src="//badges.instagram.com/static/images/ig-badge-view-24.png" alt="Instagram"/></a>
					</div>
					<?php
				}
				break;

<h1 style="text-align: center; font-size: 45px;">Thank You for Signing Up!</h1>
<p style="text-align: center;">Here"s your free report/e-book/software/download:</p>
<img class="aligncenter size-full wp-image-226" alt="cover-image-1b" src="<?php echo $images_dir; ?>/cover-image-1b.png" width="386" height="450"/>
<p style="text-align: center;"><a href="#">Right click and select "Save link as..."</a>
	<a href="#">or "Save target as..." to download this file.</a></p>
If you have any questions about the report or would like to share your thoughts about it, you can always get in touch with us here: <a href="#">link to contact page.</a>

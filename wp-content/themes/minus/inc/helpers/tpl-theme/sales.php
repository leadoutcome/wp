...
<img class="aligncenter size-full wp-image-463" alt="video-placeholder-800" src="<?php echo $images_dir; ?>/video-placeholder-800.png" width="800" height="450"/>
...
[one_fourth_first]<img class="aligncenter size-full wp-image-479" alt="icon4" src="<?php echo $images_dir; ?>/icon4.png" width="55" height="48"/>
...
<p style="text-align: center;">Sit amet, consectetur adipiscing elit. Pellentesque dapibus diam non mollis vestibulum.
	Cras rhoncus urna metus, in hendrerit neque vestibulum quis.[/one_fourth_first][one_fourth]<img class="aligncenter size-full wp-image-480" alt="icon5" src="<?php echo $images_dir; ?>/icon5.png" width="64" height="48"/></p>
...
<p style="text-align: center;">A vehicula ut, fermentum in neque. Nullam pharetra pretium vestibulum. Pellentesque porta
	venenatis velit, vel dapibus neque dapibus quis.[/one_fourth][one_fourth]<img class="aligncenter size-full wp-image-482" alt="icon6" src="<?php echo $images_dir; ?>/icon6.png" width="42" height="48"/></p>
...
<p style="text-align: center;">Sapien ut tristique. Fusce luctus imperdiet tempus. Phasellus a tortor aliquet leo at,
	tristique tellus. Quisque at condimentum elit.[/one_fourth][one_fourth_last]<img class="aligncenter size-full wp-image-483" alt="icon7" src="<?php echo $images_dir; ?>/icon7.png" width="55" height="48"/></p>
...
[one_fourth_first]<img class="aligncenter size-full wp-image-485" alt="icon8" src="<?php echo $images_dir; ?>/icon8.png" width="50" height="48"/>
<p style="text-align: center;"><strong>Nunc Lobortis Sed</strong></p>
<p style="text-align: center;">Sapien ut tristique. Fusce luctus imperdiet tempus. Phasellus a tortor aliquet leo at,
	tristique tellus. Quisque at condimentum elit.[/one_fourth_first][one_fourth]<img class="aligncenter size-full wp-image-486" alt="icon9" src="<?php echo $images_dir; ?>/icon9.png" width="48" height="48"/></p>
<p style="text-align: center;"><strong>Lorem Ipsum Dolor</strong></p>
<p style="text-align: center;">Sit amet, consectetur adipiscing elit. Pellentesque dapibus diam non mollis vestibulum.
	Cras rhoncus urna metus, in hendrerit neque vestibulum quis.[/one_fourth][one_fourth]<img class="aligncenter size-full wp-image-487" alt="icon10" src="<?php echo $images_dir; ?>/icon10.png" width="48" height="48"/></p>
<p style="text-align: center;"><strong>Ut Tellus Odio Ultricies</strong></p>
<p style="text-align: center;">A vehicula ut, fermentum in neque. Nullam pharetra pretium vestibulum. Pellentesque porta
	venenatis velit, vel dapibus neque dapibus quis.[/one_fourth][one_fourth_last]<img class="aligncenter size-full wp-image-488" alt="icon11" src="<?php echo $images_dir; ?>/icon11.png" width="48" height="48"/></p>
<p style="text-align: center;"><strong>Nunc Lobortis Sed</strong></p>
<p style="text-align: center;">Sapien ut tristique. Fusce luctus imperdiet tempus. Phasellus a tortor aliquet leo at,
...
<img class="aligncenter size-full wp-image-491" alt="icon-set" src="<?php echo $images_dir; ?>/icon-set.png" width="785" height="207"/>
...
<h3>What You'll Get When You Sign Up Today:<img class="alignright  wp-image-226" alt="cover-image-1b" src="<?php echo $images_dir; ?>/cover-image-1b.png" width="232" height="270"/></h3>
<ul>
...
[price_one_third_first title='Bronze' price='$15' time='month' btn_text='Add to Cart' btn_link='#' btn_color='blue' btn_size='medium']Lorem Ipsum Dolor[*]Sit Amet Elit[*]Adipiscing Nunc Duis[/price_one_third_first][price_one_third highlight='1' title='Silver' price='$39' time='month' btn_text='Add to Cart' btn_link='#' btn_color='green' btn_size='medium']Lorem Ipsum Dolor[*]Sit Amet Elit[*]Adipiscing Nunc Duis[/price_one_third][price_one_third_last title='Gold' price='$99' time='month' btn_text='Add to Cart' btn_link='#' btn_color='blue' btn_size='medium']Lorem Ipsum Dolor[*]Sit Amet Elit[*]Adipiscing Nunc Duis[/price_one_third_last]

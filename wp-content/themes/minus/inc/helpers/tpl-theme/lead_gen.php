...
[/one_half_first][one_half_last]<img class="aligncenter size-full wp-image-226" alt="cover-image-1b" src="<?php echo $images_dir; ?>/cover-image-1b.png" width="386" height="450"/>[/one_half_last][page_section template="1" position="bottom" padding_top="on"]
<h2 style="text-align: center;">Just Enter Your Name and Email Address Below
	to Instantly Receive Your Report:</h2>
&nbsp;

[thrive_optin color="orange" text="Sign Up Today" optin="<?php echo $optin_id; ?>" size="big" layout="horizontal"]

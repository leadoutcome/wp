...
<p>When accessing the <?php echo $options['website'] ?> website, <?php echo $options['company'] ?> will learn certain information about you during your visit.</p>
...
<p>A cookie is a very small text document, which often includes an anonymous unique identifier. When you visit a website, that site's computer asks your computer for permission to store this file in a part of your hard drive specifically designated for cookies. Each website can send its own cookie to your browser if your browser's preferences allow it, but (to protect your privacy) your browser only permits a website
	to access the cookies it has already sent to you, not the cookies sent to you by other sites.</p>
<h3>IP Addresses</h3>
...
<p>If you choose to correspond with us through email, we may retain the content of your email messages together with your email address and our responses. We provide the same protections for these electronic communications that we employ in the maintenance of information received online, mail and telephone. This also applies when you register for our website, sign up through any of our forms using your email address
	or make a purchase on this site. For further information see the email policies below.</p>
...
<p><?php echo $options['company'] ?> will not obtain personally-identifying information about you when you visit our site, unless you choose to provide such information to us, nor will such information be sold or otherwise transferred to unaffiliated third parties without the approval of the user at the time of collection.</p>
...
<p>We will use your e-mail address solely to provide timely information about <?php echo $options['company'] ?>.</p>
...
<p><?php echo $options['website'] ?> may contain links to many other websites. <?php echo $options['company'] ?> cannot guarantee the accuracy of information found at any linked site. Links to or from external sites not owned or controlled by <?php echo $options['company'] ?> do not constitute an endorsement by <?php echo $options['company'] ?> or any of its employees of the sponsors of these sites or the products or
...
<p>All copyrights, trademarks, patents and other intellectual property rights in and on our website and all content and software located on the site shall remain the sole property of <?php echo $options['company'] ?> or its licensors. The use of our trademarks, content and intellectual property is forbidden without the express written consent from <?php echo $options['company'] ?>.</p>
...
<p><?php echo $options['company'] ?> is not responsible for any of the opinions or comments posted on <?php echo $options['website'] ?>. <?php echo $options['company'] ?> is not a forum for testimonials, however provides testimonials as a means for customers to share their experiences with one another. To protect against abuse, all testimonials appear after they have been reviewed by management
	of <?php echo $options['company'] ?>. <?php echo $options['company'] ?> doe not share the opinions, views or commentary of any testimonials on <?php echo $options['website'] ?> - the opinions are strictly the views of the testimonial source.</p>
...
<p>Email is not recognized as a secure medium of communication. For this reason, we request that you do not send private information to us by email. However, doing so is allowed, but at your own risk. Some of the information you may enter on our website may be transmitted securely via a secure medium known as Secure Sockets Layer, or SSL. Credit Card information and other sensitive information is never transmitted
	via email.</p>

<p><?php echo $options['company'] ?> may use software programs to create summary statistics, which are used for such purposes as assessing the number of visitors to the different sections of our site, what information is of most and least interest, determining technical design specifications, and identifying system performance or problem areas.</p>

<p>For site security purposes and to ensure that this service remains available to all users, <?php echo $options['company'] ?> uses software programs to monitor network traffic to identify unauthorized attempts to upload or change information, or otherwise cause damage.</p>

<h3>Disclaimer and Limitation of Liability</h3>

<p><?php echo $options['company'] ?> makes no representations, warranties, or assurances as to the accuracy, currency or completeness of the content contain on this website or any sites linked to this site.</p>

<p>All the materials on this site are provided 'as is' without any express or implied warranty of any kind, including warranties of merchantability, noninfringement of intellectual property or fitness for any particular purpose. In no event shall <?php echo $options['company'] ?> or its agents or associates be liable for any damages whatsoever (including, without limitation, damages for loss of profits, business
	interruption, loss of information, injury or death) arising out of the use of or inability to use the materials, even if <?php echo $options['company'] ?> has been advised of the possibility of such loss or damages.</p>
...
<p>If you have any questions regarding this policy, or your dealings with our website, please contact us here: <?php echo $options['contact'] ?></p>

<?php echo $options['company'] ?>

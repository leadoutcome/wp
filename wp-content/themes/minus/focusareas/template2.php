...
<section class="far f2 <?php echo $focus_area_class; ?> <?php echo $section_position; ?>">
	<div class="<?php echo $wrapper_class; ?>">
		<?php if ( $current_attrs['_thrive_meta_focus_image'][0] != "" ): ?>
			<div class="left">
				<img class="f2l left" src="<?php echo $current_attrs['_thrive_meta_focus_image'][0]; ?>" alt="">
				<div class="f2r left">
		...
		<?php endif; ?>
		<div class="right">
			<a href="<?php echo $current_attrs['_thrive_meta_focus_button_link'][0]; ?>" class="btn <?php echo $btn_class; ?> big" target="<?php echo $action_link_target; ?>">

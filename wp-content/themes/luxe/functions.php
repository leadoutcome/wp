...
function thrive_more_link( $more_link, $more_link_text ) {
	...
	if ( $options['other_read_more_type'] == "button" ) {
		$output = "<a href='" . get_permalink() . "' class='mre right'><span>" . $read_more_text . "</span>" . ( $options['other_show_excerpt'] == 0 ? "<span class='awe'>&#xe608;</span>" : "" ) . "</a>";
	} else {
		$output = "<a href='" . get_permalink() . "' class='rmt right'>" . $read_more_text . "</a>";
	}

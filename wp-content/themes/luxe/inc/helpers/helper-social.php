...
function _thrive_enqueue_social_fb( $attrs ) {
	...
	<iframe style="height:70px !important;"
	        src="//www.facebook.com/plugins/likebox.php?href=<?php echo $fbUrl; ?>&width=292&height=32&colorscheme=light&show_faces=false&header=false&stream=false&show_border=false"
	        id="follow_me_content_fb"></iframe>
	<?php
}
	...
	switch ( $type ) {
		...
		case 'gprofile':
			...
			<div id="container-follow-gprofile">
				<div class="g-person" data-width="273" data-href="<?php echo $gProfileUrl; ?>" data-layout="landscape"
				     data-rel="author" id="follow_me_content_gprofile"></div>
			</div>
			<?php
			break;
		case 'gpage':
			...
			<div id="container-follow-gpage">
				<div class="g-person" data-width="273" data-href="<?php echo $gPageUrl; ?>" data-layout="landscape"
				     data-rel="author" id="follow_me_content_gprofile"></div>
			</div>
		...
		case 'twitter':
			...
			<div id="container-follow-twitter">
				<a href="https://twitter.com/<?php echo $twitterUsername; ?>" class="twitter-follow-button"
		...
		case 'pinterest':
			...
			<div id="container-follow-pinterest">
				<a data-pin-do="buttonFollow"
				   href="//www.pinterest.com/<?php echo $attr['pinterest_url'] ?>/"><?php echo ucfirst( $attr['pinterest_url'] ); ?></a>

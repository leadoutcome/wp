...
class Theme_Product extends TVE_Dash_Product_Abstract {
	...
	public function __construct( $data = array() ) {
		...
		$this->description = __( 'Smooth, luxurious design & bold typography make the Luxe theme put your content in the best light.', 'thrive' );
		...
		$this->moreLinks = array(
			...
			'tutorials' => array(
				...
				'href'       => 'https://thrivethemes.com/members/luxe/',
				'target'     => '_blank',
			...
			'support'   => array(
				...
				'href'       => 'https://thrivethemes.com/forums/forum/all-themes/luxe/',
				'target'     => '_blank',

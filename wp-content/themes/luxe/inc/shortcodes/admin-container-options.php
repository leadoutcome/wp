<table class="form-table postEdit">
	...
	<tr>
		...
		<td>
			<input type="radio" class="thrive_shortcode_option_align" value="left" checked
			       name="thrive_shortcode_option_align"/> <?php _e( "Left", 'thrive' ); ?>
			<input type="radio" class="thrive_shortcode_option_align" value="center"
			       name="thrive_shortcode_option_align"/> <?php _e( "Center", 'thrive' ); ?>
			<input type="radio" class="thrive_shortcode_option_align" value="right"
			       name="thrive_shortcode_option_align"/> <?php _e( "Right", 'thrive' ); ?>
		</td>
	</tr>
	<tr>
		<td></td>

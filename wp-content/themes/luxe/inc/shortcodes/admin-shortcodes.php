...
function thrive_print_shortcodes() {
	...
	<script type="text/javascript">
		...
		/*var thrive_shortcodes = ['Button', 'BlankSpace', 'ContentContainer', 'ContentBox', 'CustomFont', 'Borderless', 'Code', 'DividerLine', 'FollowMe', 'Phone','Accordion',
		 'GMaps', 'Grid', 'Tabs', 'Toggle', 'PageSection', 'Pullquote', 'PostsList', 'CustomMenu', 'PostsGallery', 'Optin', 'Testimonal', 'VideoSection', 'ResponsiveVideo'];*/

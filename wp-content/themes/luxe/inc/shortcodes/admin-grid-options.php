<table class="form-table postEdit">
	...
	<tr>
		<td scope="row">
		<?php _e( "Upload images", 'thrive' ) ?></th>
		<td>
			<div id="thrive_shortcode_grid_img1_container">
				<?php _e( "Column 1", 'thrive' ); ?> <input type="text" class="adminHeightInput"
				                                            id="thrive_shortcode_grid_img1"/>
				<input class="pure-button upload thrive_upload" type="button" id="thrive_shortcode_grid_img1_btn"
				       value="<?php _e( "Select", 'thrive' ); ?>"/>
			</div>
			<br/>
			<div id="thrive_shortcode_grid_img2_container">
				<?php _e( "Column 2", 'thrive' ); ?> <input type="text" class="adminHeightInput"
				                                            id="thrive_shortcode_grid_img2"/>
				<input class="pure-button upload thrive_upload" type="button" id="thrive_shortcode_grid_img2_btn"
				       value="<?php _e( "Select", 'thrive' ); ?>"/>
			</div>
			<br/>
			<div id="thrive_shortcode_grid_img3_container">
				<?php _e( "Column 3", 'thrive' ); ?> <input type="text" class="adminHeightInput"
				                                            id="thrive_shortcode_grid_img3"/>
				<input class="pure-button upload thrive_upload" type="button" id="thrive_shortcode_grid_img3_btn"
				       value="<?php _e( "Select", 'thrive' ); ?>"/>
			</div>
			<br/>
			<div id="thrive_shortcode_grid_img4_container">
				<?php _e( "Column 4", 'thrive' ); ?> <input type="text" class="adminHeightInput"
				                                            id="thrive_shortcode_grid_img4"/>
				<input class="pure-button upload thrive_upload" type="button" id="thrive_shortcode_grid_img4_btn"
				       value="<?php _e( "Select", 'thrive' ); ?>"/>
			</div>
			<br/>
		</td>

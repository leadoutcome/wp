		...
		<td class="adminTabs">
			<ul>
				<li><span name="thrive_shortcode_borderless_type"
				          class="thrive_shortcode_borderless_type"
				          value="image"><?php _e( "Image", 'thrive' ); ?></span></li>
				<li><span name="thrive_shortcode_borderless_type" class="thrive_shortcode_borderless_type"
				          value="video"><?php _e( "Video", 'thrive' ); ?></span></li>
			</ul>
		</td>
	</tr>
	<tr class="thrive_shortcode_container_image">
		<td>
			<input class="adminHeightInput" type="text" id="thrive_shortcode_borderless_image_text"
			       name="thrive_shortcode_borderless_image_text" style="width: 200px;"/>
			<input class="pure-button upload" type="button" id="thrive_shortcode_borderless_image_btn"
			       value="<?php _e( "Upload / Insert", 'thrive' ); ?>"/>
			<input class="pure-button remove" type="button" id="thrive_shortcode_borderless_remove_image_btn"
			       value="Remove"/>
		</td>
	</tr>
				...
				<tr class="thrive_shortcode_container_video_youtube noBorder">
					...
					<td>
						...
						<input type="checkbox" name="thrive_shortcode_borderless_youtube_autoplay"
						       id="thrive_shortcode_borderless_youtube_autoplay"
						       value="1"/> <?php _e( "Autoplay", 'thrive' ); ?> <br/>

...
function thrive_meta_focusarea_options( $page ) {
	...
	$focus_templates = array( '2' => 'Template 2', '4' => 'Template 4', '0' => 'Custom Template' );
	...
	if ( empty( $value_focus_template ) ||
	     ( strtolower( $value_focus_template ) != "template2" && strtolower( $value_focus_template ) != "template4" ) && strtolower( $value_focus_template ) != "template0"
	) {
...
function _thrive_save_focus_options( $post_data ) {
	...
	$thrive_meta_focus_custom_text     = isset( $post_data['thrive_meta_focus_custom_text'] ) ? $post_data['thrive_meta_focus_custom_text'] : '';
...
function thrive_focus_render_preview() {
	...
	$current_attrs['_thrive_meta_focus_button_color'][0]    = isset( $_POST['thrive_meta_focus_button_color'] ) ? $_POST['thrive_meta_focus_button_color'] : '';

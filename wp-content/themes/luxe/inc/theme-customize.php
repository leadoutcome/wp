...
class MyTheme_Customize {
	...
	public static function header_output() {
		...
		<style type="text/css"><?php
			...
			self::generate_css( '.bSe h2, .tve-woocommerce .bSe h2, .cnt article .entry-title', 'font-family', 'thrivetheme_header_font', '' );
			...
			self::generate_css( 'header nav ul.menu > li.h-cta > a:hover', 'color', 'thrivetheme_highlight_hover_link_color', '', '!important' );
			self::generate_css( 'header nav ul.menu > li.h-cta > a:hover', 'background', 'thrivetheme_highlight_hover_background_color', '' );
			self::generate_css( 'header nav ul.menu > li.h-cta > a:hover', 'border-color', 'thrivetheme_highlight_hover_background_color', '' );
			?></style>
		<?php
	}

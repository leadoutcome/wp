...
function thrive_enqueue_scripts() {
	...
	wp_enqueue_style( 'luxe-style', get_stylesheet_uri() );
...
function thrive_init_widgets() {
	...
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'before_widget' => '<section id="%1$s"><div class="scn"><div class="awr">',
...
function thrive_check_sidebar_params( $params ) {
	...
	if ( isset( $settings['title'] ) && empty( $settings['title'] ) && ( $params[0]['id'] == "sidebar-1" || $params[0]['id'] == "sidebar-2" ) ) {
		...
		if ( in_array( $params[0]['widget_name'], $widgets_without_default_titles ) ) {
			//$params[0]['before_widget'] = '<section><div class="scn"><div class="awr">';
			//$params[0]['after_widget'] = '</div></div></section>';
		}
	}
...
function thrive_license_notice() {
	...
	<div id="tve_license_notice">
		...
		<p>You need to <a
				...
				your license</a> before you can use the theme!</p></div>
	<style type="text/css">
		#tve_license_notice {
			width: 500px;
			margin: 0 auto;

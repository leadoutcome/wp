...
function _thrive_get_theme_image_sizes_array( $key = null ) {
	...
	$tt_image_sizes = array(
		...
		"tt_related_posts"         => array( 350, 200 ), //related posts
		"tt_grid_layout"           => array( 300, 200 ), //grid si masonry si post gallery
		"tt_featured_wide_sidebar" => array( 710, 350 ),
		"tt_featured_wide_narrow"  => array( 844, 430 ),
		"tt_featured_wide_full"    => array( 1060, 530 ),
	);

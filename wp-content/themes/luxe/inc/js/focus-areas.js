...
ThriveFocusOptions.display_fields = {
    ...
    template2: ["container-focus-template", "container-focus-color", "container-heading-text", "container-subheading-text", "container-button-text",
        "container-button-link", "container-new-tab", "container-focus-image", "container-button-color"],
    ...
    template4: ["container-focus-template", "container-focus-color", "container-heading-text", "container-focus-image",
...
ThriveFocusOptions.hide_fields = {
    ...
    template3: ["postdivrich", "container-button-link", "container-new-tab", "container-focus-image", "container-custom-text", "container-spam-disclaimer"],
    template4: ["container-button-link", "container-new-tab", "container-custom-text"],
    template5: ["container-button-link", "container-new-tab", "container-custom-text"],
    custom: ["container-heading-text", "container-button-text",
        "container-spam-disclaimer", "container-focus-image", "container-button-color", "container-button-link", "container-new-tab", "container-optin", "container-custom-text"]
};
/*

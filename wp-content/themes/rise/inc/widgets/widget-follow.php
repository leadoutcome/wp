...
class Thrive_Follow_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'widget_thrive_follow',
			'description' => __( 'Invite visitors to follow you on social media.', 'thrive' )
		);
					...
					<ul>
						...
						foreach ( $items as $key => $item ):
							...
							<li class="sm_icons">
								...
								<?php endif; ?>
								<a href="<?php if ( $item['type'] == "dribble" || $item['type'] == "rss" || $item['type'] == 'xing' ): ?><?php echo $item['url']; ?><?php else: ?>javascript:void(0)<?php endif; ?>"
								   class="sm <?php echo $item['a_class'] . " " . $item['col_class'] ?>"
								   rel="<?php echo $item['type']; ?>">
									<span></span>
								</a>
							</li>
	...
	function _build_items_array( $instance ) {
		...
		if ( isset( $instance['twitter_active'] ) && $instance['twitter_active'] == 1 && $instance['twitter_url'] && $instance['twitter_url'] != "" ) {
			$items[] = array(
				'type'         => 'twitter',
				'url'          => _thrive_get_twitter_link( $instance['twitter_url'] ),
				'a_class'      => 'tw',
				'col_class'    => 'sm-1col',
				'span_content' => "&#xf099;"
			);
	...
	function form( $instance ) {
		...
		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'twitter_active' ) ); ?>"><b><?php _e( 'Twitter', 'thrive' ); ?></b></label>
			<br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'twitter_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'twitter_active' ) ); ?>"
			       <?php if ( $twitter_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'twitter_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'twitter_active' ) ); ?>"
			       <?php if ( $twitter_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label
					for="<?php echo esc_attr( $this->get_field_id( 'twitter_url' ) ); ?>"><?php _e( 'Twitter username:', 'thrive' ); ?></label>
		...
		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'facebook_active' ) ); ?>"><b><?php _e( 'Facebook page', 'thrive' ); ?></b></label>
			<br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'facebook_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'facebook_active' ) ); ?>"
			       <?php if ( $facebook_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'facebook_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'facebook_active' ) ); ?>"
			       <?php if ( $facebook_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label
					for="<?php echo esc_attr( $this->get_field_id( 'facebook_url' ) ); ?>"><?php _e( 'Page url:', 'thrive' ); ?></label>
		...
		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'gprofile_active' ) ); ?>"><b><?php _e( 'Google+ profile', 'thrive' ); ?></b></label>
			<br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'gprofile_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'gprofile_active' ) ); ?>"
			       <?php if ( $gprofile_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'gprofile_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'gprofile_active' ) ); ?>"
			       <?php if ( $gprofile_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label
					for="<?php echo esc_attr( $this->get_field_id( 'gprofile_url' ) ); ?>"><?php _e( 'Profile url', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'gprofile_url' ) ); ?>"
				   name="<?php echo esc_attr( $this->get_field_name( 'gprofile_url' ) ); ?>" type="text"
				   value="<?php echo esc_attr( $gprofile_url ); ?>"/></p>

		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'gpage_active' ) ); ?>"><b><?php _e( 'Google+ Page', 'thrive' ); ?></b></label>
			<br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'gpage_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'gpage_active' ) ); ?>"
			       <?php if ( $gpage_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'gpage_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'gpage_active' ) ); ?>"
			       <?php if ( $gpage_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label
					for="<?php echo esc_attr( $this->get_field_id( 'gpage_url' ) ); ?>"><?php _e( 'Page url:', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'gpage_url' ) ); ?>"
				   name="<?php echo esc_attr( $this->get_field_name( 'gpage_url' ) ); ?>" type="text"
				   value="<?php echo esc_attr( $gpage_url ); ?>"/></p>

		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'linkedin_active' ) ); ?>"><b><?php _e( 'LinkedIn', 'thrive' ); ?></b></label>
			<br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'linkedin_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'linkedin_active' ) ); ?>"
			       <?php if ( $linkedin_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'linkedin_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'linkedin_active' ) ); ?>"
			       <?php if ( $linkedin_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label
					for="<?php echo esc_attr( $this->get_field_id( 'linkedin_url' ) ); ?>"><?php _e( 'Company or profile URL', 'thrive' ); ?></label>
		...
		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'dribble_active' ) ); ?>"><b><?php _e( 'Dribble', 'thrive' ); ?></b></label>
			<br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'dribble_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'dribble_active' ) ); ?>"
			       <?php if ( $dribble_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'dribble_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'dribble_active' ) ); ?>"
			       <?php if ( $dribble_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label
					for="<?php echo esc_attr( $this->get_field_id( 'dribble_url' ) ); ?>"><?php _e( 'Dribble username:', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'dribble_url' ) ); ?>"
				   name="<?php echo esc_attr( $this->get_field_name( 'dribble_url' ) ); ?>" type="text"
				   value="<?php echo esc_attr( $dribble_url ); ?>"/></p>

		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'pinterest_active' ) ); ?>"><b><?php _e( 'Pinterest', 'thrive' ); ?></b></label>
			<br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'pinterest_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'pinterest_active' ) ); ?>"
			       <?php if ( $pinterest_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'pinterest_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'pinterest_active' ) ); ?>"
			       <?php if ( $pinterest_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label
					for="<?php echo esc_attr( $this->get_field_id( 'pinterest_url' ) ); ?>"><?php _e( 'Pinterest url:', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'pinterest_url' ) ); ?>"
				   name="<?php echo esc_attr( $this->get_field_name( 'pinterest_url' ) ); ?>" type="text"
				   value="<?php echo esc_attr( $pinterest_url ); ?>"/></p>

		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'rss_active' ) ); ?>"><b><?php _e( 'RSS', 'thrive' ); ?></b></label>
			<br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'rss_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'rss_active' ) ); ?>"
			       <?php if ( $rss_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'rss_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'rss_active' ) ); ?>"
			       <?php if ( $rss_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label
					for="<?php echo esc_attr( $this->get_field_id( 'rss_url' ) ); ?>"><?php _e( 'RSS Feed URL', 'thrive' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'rss_url' ) ); ?>"
				   name="<?php echo esc_attr( $this->get_field_name( 'rss_url' ) ); ?>"
				   type="text" value="<?php echo esc_attr( $rss_url ); ?>"/></p>

		<p>
			<label
					for="<?php echo esc_attr( $this->get_field_id( 'youtube_active' ) ); ?>"><b><?php _e( 'Youtube', 'thrive' ); ?></b></label>
			<br/>
			<?php _e( 'Inactive', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'youtube_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'youtube_active' ) ); ?>"
			       <?php if ( $youtube_active == 0 ): ?>checked<?php endif ?> value="0"/>
			<?php _e( 'Active', 'thrive' ); ?>
			<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'youtube_active' ) ); ?>"
				   id="<?php echo esc_attr( $this->get_field_id( 'youtube_active' ) ); ?>"
			       <?php if ( $youtube_active == 1 ): ?>checked<?php endif ?> value="1"/>

		</p>
		<p><label
					for="<?php echo esc_attr( $this->get_field_id( 'youtube_url' ) ); ?>"><?php _e( 'Youtube username:', 'thrive' ); ?></label>
			...
			case 'gprofile':
				if ( isset( $instance['gprofile_active'] ) && $instance['gprofile_active'] == 1 ) {
					...
					<div id="container-follow-gprofile">
						<div class="g-person" data-width="273" data-href="<?php echo $gProfileUrl; ?>"
			...
			case 'gpage':
				if ( isset( $instance['gpage_active'] ) && $instance['gpage_active'] == 1 ) {
					...
					<div id="container-follow-gpage">
						<div class='g-follow' data-width="273" data-href="<?php echo $gPageUrl; ?>"
							 data-layout="landscape" data-rel="author"
							 id="follow_me_content_gprofile"></div>
					</div>
			...
			case 'twitter':
				if ( isset( $instance['twitter_active'] ) && $instance['twitter_active'] == 1 ) {
					...
					<div id="container-follow-twitter">
						<a href="<?php echo _thrive_get_social_link( $instance['twitter_url'], 'twitter' ); ?>"
				...
				if ( isset( $instance['youtube_active'] ) && $instance['youtube_active'] == 1 ) {
					...
					<div id="container-follow-youtube">
						<div class="g-ytsubscribe"
							 data-channelid="<?php echo _thrive_get_social_link( $instance['youtube_url'], 'youtube' ); ?>"
							 data-channel="<?php echo _thrive_get_social_link( $instance['youtube_url'], 'youtube' ); ?>"
			...
			case 'instagram':
				if ( isset( $instance['instagram_active'] ) && $instance['instagram_active'] == 1 ) {
					...
					<div id="container-follow-instagram">
						...
						<a target="_blank" href="//instagram.com/<?php echo $instance['instagram_url']; ?>?ref=badge"

...
class Thrive_Tabs_Widget extends WP_Widget {
										...
										<?php if ( empty( $c['image'] ) ): ?>
											<a href="<?php echo $c['url']; ?>">
												<div class="tim left default_tab_image">
													<div class="wti"
													     style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/default_featured.jpg')"></div>
												</div>
											</a>
										<?php else: ?>
											<a href="<?php echo $c['url']; ?>">
	...
	function _get_featured_image( $postId ) {
		...
		$featured_image_data = thrive_get_post_featured_image( $postId, "tt_post_icon", true );

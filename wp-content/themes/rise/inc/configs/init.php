...
function thrive_enqueue_scripts() {
	...
	wp_register_script( 'thrive-main-script', get_template_directory_uri() . '/js/script.js', array( 'jquery' ), "", true );
...
function thrive_enqueue_admin() {
	...
	if ( $screen->base == "post" || $screen->id == 'tcb_lightbox' ) {
		...
		wp_enqueue_script( 'admin-menu-gallery', get_template_directory_uri() . '/inc/js/admin-menu-gallery.js', array( 'jquery' ) );
		//datetime picker

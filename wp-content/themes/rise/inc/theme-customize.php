...
class MyTheme_Customize {
	...
	public static function header_output() {
		...
		<style type="text/css">.wp-video-shortcode {
			...
			self::generate_css( '.bSe h1, h1.entry-title, h1.entry-title a', 'color', 'thrivetheme_headline_color', '' );
			...
			self::generate_css( '.bSe p, .mry .awr-e p', 'color', 'thrivetheme_bodytext_color' );
			self::generate_css( '.cnt .bSe', 'color', 'thrivetheme_bodytext_color' );
			self::generate_css( '.cnt h1 a, .tve-woocommerce .bSe .awr .entry-title, .tve-woocommerce .bSe .awr .page-title', 'font-family', 'thrivetheme_header_font', '' );
			...
			self::generate_css( '.cnt h1 a', 'font-weight', 'thrivetheme_headline_weight', '' );
			...
			self::generate_css( '.bSe h4', 'font-weight', 'thrivetheme_headline_weight', '' ); // 400
			self::generate_css( '.bSe h5', 'font-weight', 'thrivetheme_headline_weight', '' ); // 400
			self::generate_css( '.bSe h6', 'font-weight', 'thrivetheme_headline_weight', '' ); // 700
			self::generate_css( '.cnt', 'font-family', 'thrivetheme_body_font' );
			self::generate_css( '.cnt p, .tve-woocommerce .product p, .tve-woocommerce .products p', 'font-family', 'thrivetheme_body_font' );
			...
			self::generate_css( '.bSe a, .cnt a', 'color', 'thrivetheme_link_color', '' );
			self::generate_css( '.bSe h1', 'text-transform', 'thrivetheme_headline_case', '' );
	...
	public static function generate_css( $selector, $style, $mod_name, $prefix = '', $postfix = '', $echo = true ) {
		...
		if ( $selector == ".bSe h2" && $mod == "#333" && $mod_name == "thrivetheme_headline_color" ) {
			$mod = "#464545";
		}
		...
		if ( $mod_name == "background_color" && $mod == "#" ) {
			$mod = '#FFF';
		}
		...
		if ( $mod_name == 'thrivetheme_header_font' || $mod_name == 'thrivetheme_body_font' ) {
			...
			if ( ! empty( $font['family'] ) ) {
				/** default font */
				if ( $mod_name == 'thrivetheme_body_font' && $mod == '//fonts.googleapis.com/css?family=Roboto:100,400,300,500,700,300italic&subset=latin,latin-ext' ) {
					$font['weight'] = '300';
				}
				echo sprintf(
